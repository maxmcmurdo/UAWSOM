...
module mod_constants
  ...
  double precision, PARAMETER :: const_G      = 6.67191d-8 !cm3 g-1 s-2      ; Cavendish gravitational constant
  double precision, PARAMETER :: const_rad_a  = 7.5657e-15 !erg cm-3 K-4      ; radiation density constant
  double precision, PARAMETER :: const_kappae = 0.34d0 !cm2 g-1           ; free-electron scattering opacity
