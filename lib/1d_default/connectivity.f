...
subroutine build_connectivity
  ...
  integer :: idir,pi1, mi1, ph1, mh1, ipe_neighbor
  ...
  do iigrid=1,igridstail; igrid=igrids(iigrid);
     ...
     do i1=-1,1
        ...
        if (i1==0) then
           ...
           case (neighbor_coarse)
              ...
              if (my_neighbor%node%ipe/=mype) then
                 ...
                 if ((i1==0.or.i1==2*ic1-3)) then
                   ...
                   nbuff_bc_send_r=nbuff_bc_send_r+sizes_r_send_total(i1)
           ...
           if (phi_ > 0) then
             neighbor_pole(i1,igrid)=0
             if (my_neighbor_type>1) then
               do idim=1,1
                 if (pole(idim)) then
                   neighbor_pole(i1,igrid)=idim
             ...
             do idir=idim+1,ndim
               ...
               if (neighbor_type(pi1,igrid)==4.and.neighbor_type(ph1,&
                ...
                do ic1=1+int((1-pi1)/2),2-int((1+pi1)/2)
                    inc1=2*pi1+ic1
                   if (mype.ne.neighbor_child(2,inc1,igrid)) then
