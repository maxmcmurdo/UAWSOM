...
contains
  ...
  subroutine sample_fill_gridvars
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
      ...
      ! fill all variables:
      gridvars(igrid)%w(ixGlo1:ixGhi1,1:ngridvars) = w(ixGlo1:ixGhi1,&
         1:ngridvars)
      ...
      if(time_advance) then
        ...
        call phys_to_primitive(ixGlo1,ixGhi1,ixGlo1,ixGhi1,w,ps(igrid)%x)
        gridvars(igrid)%wold(ixGlo1:ixGhi1,1:ngridvars) = w(ixGlo1:ixGhi1,&
           1:ngridvars)
      end if
    ...
    do ii=1,mynpayload
      if (.not.time_advance) then
        ...
        call interpolate_var(igrid,ixGlo1,ixGhi1,ixMlo1,ixMhi1,&
           wold(ixGlo1:ixGhi1,ii),xgrid,xpart,wp1)
        call interpolate_var(igrid,ixGlo1,ixGhi1,ixMlo1,ixMhi1,w(ixGlo1:ixGhi1,&
           ii),xgrid,xpart,wp2)
