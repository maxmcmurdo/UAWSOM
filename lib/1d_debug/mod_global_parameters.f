...
module mod_global_parameters
  ...
  integer :: type_coarse_block_stg(1,2), type_sub_block_stg(1,2)
...
contains
  ...
  pure subroutine cross_product(ixImin1,ixImax1,ixOmin1,ixOmax1,a,b,axb)
    integer, intent(in) :: ixImin1,ixImax1, ixOmin1,ixOmax1
    double precision, intent(in) :: a(ixImin1:ixImax1,3), b(ixImin1:ixImax1,3)
    double precision, intent(out) :: axb(ixImin1:ixImax1,3)

    axb(ixOmin1:ixOmax1,1)=a(ixOmin1:ixOmax1,2)*b(ixOmin1:ixOmax1,&
       3)-a(ixOmin1:ixOmax1,3)*b(ixOmin1:ixOmax1,2)
    axb(ixOmin1:ixOmax1,2)=a(ixOmin1:ixOmax1,3)*b(ixOmin1:ixOmax1,&
       1)-a(ixOmin1:ixOmax1,1)*b(ixOmin1:ixOmax1,3)
    axb(ixOmin1:ixOmax1,3)=a(ixOmin1:ixOmax1,1)*b(ixOmin1:ixOmax1,&
       2)-a(ixOmin1:ixOmax1,2)*b(ixOmin1:ixOmax1,1)
