...
module mod_usr_methods
  ...
  abstract interface
    ...
    subroutine special_aniso_opacity(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
       ixOmin2,ixOmax1,ixOmax2,w,x,kappa,idir)
      use mod_global_parameters
      integer, intent(in)          :: ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
    ...
    subroutine set_equi_vars(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
       ixOmax1,ixOmax2,x,w0)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImax1,ixImax2,&
         ixOmin1,ixOmin2,ixOmax1,ixOmax2
      double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
    ...
    subroutine update_payload(igrid,w,wold,xgrid,x,u,q,m,mypayload,mynpayload,&
      ...
      double precision, intent(in)  :: xgrid(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         1:ndim),x(1:ndir),u(1:ndir),q,m,particle_time
