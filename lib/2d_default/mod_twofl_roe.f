...
contains
  ...
  subroutine twofl_average(wL,wR,x,ixmin1,ixmin2,ixmax1,ixmax2,idim,wroe,&
     workroe)
    use mod_global_parameters
  ...
  subroutine average2(wL,wR,x,ixmin1,ixmin2,ixmax1,ixmax2,idim,wroe,cfast,&
     cslow,afast,aslow,csound2,dp, rhodv,tmp)
    use mod_global_parameters
    ...
    wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)=half*(wL(ixmin1:ixmax1,&
       ixmin2:ixmax2,rho_c_)+wR(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_))
    do idir=1,ndir
      wroe(ixmin1:ixmax1,ixmin2:ixmax2,mom_c(idir))=half*(wL(ixmin1:ixmax1,&
         ixmin2:ixmax2,mom_c(idir))/wL(ixmin1:ixmax1,ixmin2:ixmax2,&
         rho_c_)+wR(ixmin1:ixmax1,ixmin2:ixmax2,mom_c(idir))/wR(ixmin1:ixmax1,&
         ixmin2:ixmax2,rho_c_))
    ...
    call twofl_get_pthermal_c(wL,x,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixmin1,ixmin2,&
       ixmax1,ixmax2,afast)
    call twofl_get_pthermal_c(wR,x,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixmin1,ixmin2,&
       ixmax1,ixmax2,aslow)

    if(twofl_eq_energy/=0) then
      wroe(ixmin1:ixmax1,ixmin2:ixmax2,e_c_)=half*(afast(ixmin1:ixmax1,&
         ixmin2:ixmax2)+aslow(ixmin1:ixmax1,ixmin2:ixmax2))
      ! dp=pR-pL
      dp(ixmin1:ixmax1,ixmin2:ixmax2)=aslow(ixmin1:ixmax1,&
    ...
    rhodv(ixmin1:ixmax1,ixmin2:ixmax2)=wR(ixmin1:ixmax1,ixmin2:ixmax2,&
       mom_c(idim))-wL(ixmin1:ixmax1,ixmin2:ixmax2,&
       mom_c(idim))-wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
       mom_c(idim))*(wR(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)-wL(ixmin1:ixmax1,&
       ixmin2:ixmax2,rho_c_))
    ...
    ! get csound**2
    if(twofl_eq_energy/=0) then
      csound2(ixmin1:ixmax1,ixmin2:ixmax2)=twofl_gamma*wroe(ixmin1:ixmax1,&
         ixmin2:ixmax2,e_c_)/wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)
    else
      csound2(ixmin1:ixmax1,ixmin2:ixmax2)=twofl_gamma*twofl_adiab*wroe(&
         ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)**(twofl_gamma-one)
    end if

    ! aa=B**2/rho+a**2
    cfast(ixmin1:ixmax1,ixmin2:ixmax2)=sum(wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
       mag(:))**2,dim=ndim+1)/wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
       rho_c_)+csound2(ixmin1:ixmax1,ixmin2:ixmax2)
    ...
    cslow(ixmin1:ixmax1,ixmin2:ixmax2)=half*(cfast(ixmin1:ixmax1,&
       ...
       mag(idim))**2/wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)))
    ...
    ! rho -> dsqrt(rho)
    wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)=dsqrt(wroe(ixmin1:ixmax1,&
       ixmin2:ixmax2,rho_c_))
  ...
  subroutine twofl_get_eigenjump(wL,wR,wroe,x,ixmin1,ixmin2,ixmax1,ixmax2,il,&
  ...
  subroutine geteigenjump2(wL,wR,wroe,x,ixmin1,ixmin2,ixmax1,ixmax2,il,idim,&
    ...
    if(il==fastRW_)then
       ...
       bdv(ixmin1:ixmax1,ixmin2:ixmax2)=wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          ...
          mom_c(idir))/wR(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)-wL(ixmin1:ixmax1,&
          ixmin2:ixmax2,mom_c(idir))/wL(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_))
       if(ndir==3)bdv(ixmin1:ixmax1,ixmin2:ixmax2)=bdv(ixmin1:ixmax1,&
          ixmin2:ixmax2)+wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          mag(jdir))* (wR(ixmin1:ixmax1,ixmin2:ixmax2,&
          mom_c(jdir))/wR(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)-wL(ixmin1:ixmax1,&
          ixmin2:ixmax2,mom_c(jdir))/wL(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_))
       bdv(ixmin1:ixmax1,ixmin2:ixmax2)=bdv(ixmin1:ixmax1,&
          ixmin2:ixmax2)*sign(wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)**2,&
       ...
       bdb(ixmin1:ixmax1,ixmin2:ixmax2)=bdb(ixmin1:ixmax1,&
          ...
          ixmin2:ixmax2))*wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)
    endif
    ...
    if(il==alfvRW_)then
       ...
       bdv(ixmin1:ixmax1,ixmin2:ixmax2)=wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          ...
          mom_c(idir))/wR(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)-wL(ixmin1:ixmax1,&
          ixmin2:ixmax2,mom_c(idir))/wL(ixmin1:ixmax1,ixmin2:ixmax2,&
          rho_c_)) -wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          mag(idir))* (wR(ixmin1:ixmax1,ixmin2:ixmax2,&
          mom_c(jdir))/wR(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)-wL(ixmin1:ixmax1,&
          ixmin2:ixmax2,mom_c(jdir))/wL(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_))
       bdb(ixmin1:ixmax1,ixmin2:ixmax2)=wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          ...
          mag(jdir))-wL(ixmin1:ixmax1,ixmin2:ixmax2,mag(jdir)))
       bdv(ixmin1:ixmax1,ixmin2:ixmax2)=bdv(ixmin1:ixmax1,&
          ixmin2:ixmax2)*half*wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)**2
       bdb(ixmin1:ixmax1,ixmin2:ixmax2)=bdb(ixmin1:ixmax1,&
          ixmin2:ixmax2)*half*sign(wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_),&
          wroe(ixmin1:ixmax1,ixmin2:ixmax2,mag(idim)))
    endif
    ...
    case(fastRW_)
       a(ixmin1:ixmax1,ixmin2:ixmax2)=wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          mom_c(idim))+cfast(ixmin1:ixmax1,ixmin2:ixmax2)
       jump(ixmin1:ixmax1,ixmin2:ixmax2)=half/csound2(ixmin1:ixmax1,&
          ...
          ixmin2:ixmax2)*rhodv(ixmin1:ixmax1,ixmin2:ixmax2)+dp(ixmin1:ixmax1,&
    ...
    case(slowRW_)
       a(ixmin1:ixmax1,ixmin2:ixmax2)=wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          mom_c(idim))+cslow(ixmin1:ixmax1,ixmin2:ixmax2)
       jump(ixmin1:ixmax1,ixmin2:ixmax2)=half/csound2(ixmin1:ixmax1,&
          ixmin2:ixmax2)*(aslow(ixmin1:ixmax1,&
          ixmin2:ixmax2)*(+cslow(ixmin1:ixmax1,&
          ixmin2:ixmax2)*rhodv(ixmin1:ixmax1,ixmin2:ixmax2)+dp(ixmin1:ixmax1,&
    ...
    case(entroW_)
       ...
       jump(ixmin1:ixmax1,ixmin2:ixmax2)=wR(ixmin1:ixmax1,ixmin2:ixmax2,&
          rho_c_)-wL(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)-dp(ixmin1:ixmax1,&
    ...
    case(alfvRW_)
       a(ixmin1:ixmax1,ixmin2:ixmax2)=wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          mom_c(idim))+dabs(wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          mag(idim)))/wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)
    ...
    case('harten','powell', 'ratio')
       ...
       aL(ixmin1:ixmax1,ixmin2:ixmax2)= wL(ixmin1:ixmax1,ixmin2:ixmax2,&
          mom_c(idim))/wL(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)
       aR(ixmin1:ixmax1,ixmin2:ixmax2)= wR(ixmin1:ixmax1,ixmin2:ixmax2,&
          mom_c(idim))/wR(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)
       ...
       case(fastRW_)
          ...
          call twofl_get_csound2_c_from_conserved(wL,x,ixGlo1,ixGlo2,ixGhi1,&
             ixGhi2,ixmin1,ixmin2,ixmax1,ixmax2,cs2L)
          call twofl_get_csound2_c_from_conserved(wR,x,ixGlo1,ixGlo2,ixGhi1,&
             ixGhi2,ixmin1,ixmin2,ixmax1,ixmax2,cs2R)
          cs2ca2L(ixmin1:ixmax1,ixmin2:ixmax2)=cs2L(ixmin1:ixmax1,&
             ixmin2:ixmax2)+sum(wL(ixmin1:ixmax1,ixmin2:ixmax2,mag(:))**2,&
             dim=ndim+1)/wL(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)
          cs2ca2R(ixmin1:ixmax1,ixmin2:ixmax2)=cs2R(ixmin1:ixmax1,&
             ixmin2:ixmax2)+sum(wR(ixmin1:ixmax1,ixmin2:ixmax2,mag(:))**2,&
             dim=ndim+1)/wR(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)
          ...
          cs2L(ixmin1:ixmax1,ixmin2:ixmax2)=dsqrt(cs2ca2L(ixmin1:ixmax1,&
             ...
             mag(idim))**2/wL(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_))
          cs2R(ixmin1:ixmax1,ixmin2:ixmax2)=dsqrt(cs2ca2R(ixmin1:ixmax1,&
             ...
             mag(idim))**2/wR(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_))
  ...
  subroutine twofl_rtimes(q,w,ixmin1,ixmin2,ixmax1,ixmax2,iw,il,idim,rq,&
     workroe)
    use mod_global_parameters
    ...
    if(iw == rho_c_) then
      ...
      if(il==fastRW_)then
        ...
        v2a2(ixmin1:ixmax1,ixmin2:ixmax2)=half*sum(wroe(ixmin1:ixmax1,&
           ixmin2:ixmax2,mom_c(:))**2,dim=ndim+1)+ &
           (two-twofl_gamma)/(twofl_gamma-one)*csound2(ixmin1:ixmax1,&
           ixmin2:ixmax2)
        ! Store sgn(bx)*(betay*vy+betaz*vz) in bv
        bv(ixmin1:ixmax1,ixmin2:ixmax2)=wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
           mag(idir))*wroe(ixmin1:ixmax1,ixmin2:ixmax2,mom_c(idir))
        if(ndir==3)bv(ixmin1:ixmax1,ixmin2:ixmax2)=bv(ixmin1:ixmax1,&
           ixmin2:ixmax2)+wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
           mag(jdir))*wroe(ixmin1:ixmax1,ixmin2:ixmax2,mom_c(jdir))
        ...
        bv(ixmin1:ixmax1,ixmin2:ixmax2)=(wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
           ...
           mom_c(idir))-wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
           mag(idir))*wroe(ixmin1:ixmax1,ixmin2:ixmax2,mom_c(jdir)))
      endif
      ...
      case(fastRW_)
        rq(ixmin1:ixmax1,ixmin2:ixmax2)=q(ixmin1:ixmax1,&
           ...
           ixmin2:ixmax2)+cfast(ixmin1:ixmax1,&
           ixmin2:ixmax2)*(cfast(ixmin1:ixmax1,&
           ixmin2:ixmax2)+wroe(ixmin1:ixmax1,ixmin2:ixmax2,mom_c(idim)))))
      case(fastLW_)
        rq(ixmin1:ixmax1,ixmin2:ixmax2)=q(ixmin1:ixmax1,&
           ixmin2:ixmax2)*(+aslow(ixmin1:ixmax1,&
           ixmin2:ixmax2)*cslow(ixmin1:ixmax1,ixmin2:ixmax2)*bv(ixmin1:ixmax1,&
      ...
      case(entroW_)
        rq(ixmin1:ixmax1,ixmin2:ixmax2)= q(ixmin1:ixmax1,&
           ixmin2:ixmax2)*half*sum(wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
           mom_c(:))**2,dim=ndim+1)
      case(diverW_)
        if(divbwave)then
          rq(ixmin1:ixmax1,ixmin2:ixmax2)= q(ixmin1:ixmax1,&
      ...
      if(iw==mom_c(idim))then
        ...
        case(fastRW_)
          rq(ixmin1:ixmax1,ixmin2:ixmax2)=q(ixmin1:ixmax1,&
             ...
             ixmin2:ixmax2)*wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
             mag(1)-mom_c(1)+iw)*sign(one,wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
             mag(idim))))
        case(fastLW_)
          rq(ixmin1:ixmax1,ixmin2:ixmax2)=q(ixmin1:ixmax1,&
             ixmin2:ixmax2)*(afast(ixmin1:ixmax1,&
      ...
      if(iw==mag(idim))then
        ...
        case(fastRW_,fastLW_)
          rq(ixmin1:ixmax1,ixmin2:ixmax2)=+q(ixmin1:ixmax1,&
             ...
             ixmin2:ixmax2)*dsqrt(csound2(ixmin1:ixmax1,&
             ixmin2:ixmax2))*wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
             iw)/wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_)
        case(slowRW_,slowLW_)
          rq(ixmin1:ixmax1,ixmin2:ixmax2)=-q(ixmin1:ixmax1,&
             ixmin2:ixmax2)*afast(ixmin1:ixmax1,&
             ixmin2:ixmax2)*dsqrt(csound2(ixmin1:ixmax1,&
        ...
        case(alfvRW_,alfvLW_)
          if(iw==mag(idir))then
            rq(ixmin1:ixmax1,ixmin2:ixmax2)=-q(ixmin1:ixmax1,&
               ixmin2:ixmax2)*wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
               mag(jdir))/sign(wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_),&
               wroe(ixmin1:ixmax1,ixmin2:ixmax2,mag(idim)))
          else
            rq(ixmin1:ixmax1,ixmin2:ixmax2)=+q(ixmin1:ixmax1,&
               ixmin2:ixmax2)*wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
               mag(idir))/sign(wroe(ixmin1:ixmax1,ixmin2:ixmax2,rho_c_),&
               wroe(ixmin1:ixmax1,ixmin2:ixmax2,mag(idim)))
          end if
        end select
