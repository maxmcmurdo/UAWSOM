...
subroutine refine_tree_leaf(child_igrid,child_ipe,igrid,ipe,active)
  ...
  do ic1=1,2
     ...
     call init_tree_leaf(child,child_ig1,child_ig2,child_level,&
         child_igrid(ic1,ic2),child_ipe(ic1,ic2),active)
    ...
    recursive subroutine read_node(tree,ig1,ig2,level)
      ...
      if (leaf) then
         ...
         do ic1=1,2
            ...
            call read_node(tree%node%child(ic1,ic2),child_ig1,child_ig2,&
               child_level)
         end do
         end do
      end if
