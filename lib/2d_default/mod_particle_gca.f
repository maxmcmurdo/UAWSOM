...
contains
  ...
  subroutine gca_fill_gridvars
    ...
    double precision, dimension(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:ndir) :: beta
    double precision, dimension(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw)   :: w,wold
    double precision                          :: current(ixGlo1:ixGhi1,&
       ixGlo2:ixGhi2,7-2*ndir:3)
    integer                                   :: idirmin
    double precision, dimension(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:ndir) :: vE,&
        bhat
    double precision, dimension(ixGlo1:ixGhi1,ixGlo2:ixGhi2)        :: kappa,&
        kappa_B, absB, tmp
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
      ...
      call phys_to_primitive(ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixGlo1,ixGlo2,ixGhi1,&
         ixGhi2,w,ps(igrid)%x)
      ! fill with velocity:
      gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,vp(:)) = w(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,iw_mom(:))

      ! grad(kappa B)
      absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = &
         sqrt(sum(gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(:))**2,&
         dim=ndim+1))
      vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,ep(2)) * gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         bp(3)) - gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         ep(3)) * gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(2))
      vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,2) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,ep(3)) * gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         bp(1)) - gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         ep(1)) * gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(3))
      vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,3) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,ep(1)) * gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         bp(2)) - gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         ep(2)) * gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(1))
      do idir=1,ndir
        where (absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2) .gt. 0.d0)
          vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,idir) = vE(ixGlo1:ixGhi1,&
             ixGlo2:ixGhi2,idir) / absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2)**2
        elsewhere
          vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,idir) = 0.d0
        end where
      end do
      if (any(sum(vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,:)**2,&
      ...
      if (relativistic) then
        kappa(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = 1.d0/sqrt(1.0d0 - &
           sum(vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,:)**2,dim=ndim+1)/c_norm**2)
      else
        kappa(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = 1.d0
      end if
      kappa_B(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = absB(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2) / kappa(ixGlo1:ixGhi1,ixGlo2:ixGhi2)
      ...
      do idim=1,ndim
        call gradient(kappa_B,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixGlo1+1,ixGlo2+1,&
           ixGhi1-1,ixGhi2-1,idim,tmp)
        gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
      ...
      do idir=1,ndir
        where (absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2) .gt. 0.d0)
          bhat(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
             idir) = gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
             bp(idir)) / absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2)
        elsewhere
          bhat(ixGlo1:ixGhi1,ixGlo2:ixGhi2,idir) = 0.d0
        end where
      end do
      ...
      do idir=1,ndir
        ...
        do idim=1,ndim
          call gradient(bhat(ixGlo1:ixGhi1,ixGlo2:ixGhi2,idir),ixGlo1,ixGlo2,&
             ixGhi1,ixGhi2,ixGlo1+1,ixGlo2+1,ixGhi1-1,ixGhi2-1,idim,tmp)
          gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
             b_dot_grad_b(idir)) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
             ixGlo2:ixGhi2,b_dot_grad_b(idir)) + bhat(ixGlo1:ixGhi1,&
             ixGlo2:ixGhi2,idim) * tmp(ixGlo1:ixGhi1,ixGlo2:ixGhi2)
          gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
             vE_dot_grad_b(idir)) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
             ixGlo2:ixGhi2,vE_dot_grad_b(idir)) + vE(ixGlo1:ixGhi1,&
             ixGlo2:ixGhi2,idim) * tmp(ixGlo1:ixGhi1,ixGlo2:ixGhi2)
          call gradient(vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,idir),ixGlo1,ixGlo2,&
             ixGhi1,ixGhi2,ixGlo1+1,ixGlo2+1,ixGhi1-1,ixGhi2-1,idim,tmp)
          gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
             b_dot_grad_vE(idir)) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
             ixGlo2:ixGhi2,b_dot_grad_vE(idir)) + bhat(ixGlo1:ixGhi1,&
             ixGlo2:ixGhi2,idim) * tmp(ixGlo1:ixGhi1,ixGlo2:ixGhi2)
          gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
             vE_dot_grad_vE(idir)) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
             ixGlo2:ixGhi2,vE_dot_grad_vE(idir)) + vE(ixGlo1:ixGhi1,&
             ixGlo2:ixGhi2,idim) * tmp(ixGlo1:ixGhi1,ixGlo2:ixGhi2)
        end do
      end do
      ...
      if(time_advance) then
        ! Fluid velocity
        w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw) = pso(igrid)%w(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,1:nw)
        call phys_to_primitive(ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixGlo1,ixGlo2,&
           ixGhi1,ixGhi2,w,ps(igrid)%x)
        gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           vp(:)) = w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,iw_mom(:))

        ! grad(kappa B)
        absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = &
           sqrt(sum(gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(:))**2,&
           dim=ndim+1))
        vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1) = gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,ep(2)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,bp(3)) - gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,ep(3)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,bp(2))
        vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,2) = gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,ep(3)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,bp(1)) - gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,ep(1)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,bp(3))
        vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,3) = gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,ep(1)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,bp(2)) - gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,ep(2)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,bp(1))
        do idir=1,ndir
          where (absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2) .gt. 0.d0) 
  ...
  subroutine gca_integrate_particles(end_time)
    ...
    integer                             :: nok, nbad, ic11,ic12, ic21,ic22,&
        ierror, nvar
    integer                             :: ipart, iipart, seed, ic1,ic2,&
    ...
    ! y(ndir+3) = particle(ipart)%self%u(3) ! Lorentz factor of particle
      ...
      if(.not. particle_in_igrid(ipart_working,igrid_working)) then
        ...
        if (ps(igrid_working)%x(ic1,ic2,1) .lt. y(1)) then
           ic11 = ic1
        else
           ic11 = ic1 -1
        end if
        ...
        if (ps(igrid_working)%x(ic1,ic2,2) .lt. y(2)) then
           ic12 = ic2
        else
           ic12 = ic2 -1
        end if
...
!       call odeint(y,nvar,tloc,tloc+dt_p,eps,h1,hmin,nok,nbad,derivs_gca,rkqs)
  ...
  subroutine gca_update_payload(igrid,w,wold,xgrid,xpart,upart,qpart,mpart,&
    ...
    double precision, intent(in)  :: xgrid(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:ndim),&
       xpart(1:ndir),upart(1:ndir),qpart,mpart,particle_time
  ...
  function gca_get_particle_dt(partp, end_time) result(dt_p)
    ...
    integer                     :: ipart, iipart, nout, ic1,ic2,&
