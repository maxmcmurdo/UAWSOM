        ...
        if(energy) then
          if(iw_equi_rho>0) then
            w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,iw_e)=w(ixOmin1:ixOmax1,&
               ...
               iw_mom(idim))/(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
               iw_rho)+block%equi_vars(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
               iw_equi_rho,0))*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,iw_rho)
