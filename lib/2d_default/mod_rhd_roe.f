...
contains
  ...
  !> rho -> rho, m -> v, e -> h
  subroutine rhd_average(wL,wR,x,ixmin1,ixmin2,ixmax1,ixmax2,idim,wroe,&
     workroe)
    ...
    call rhd_get_pthermal(wL,x,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixmin1,ixmin2,&
       ixmax1,ixmax2, workroe(ixGlo1:ixGhi1,ixGlo2:ixGhi2, 2))
    ...
    call rhd_get_pthermal(wR,x,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixmin1,ixmin2,&
       ixmax1,ixmax2, workroe(ixGlo1:ixGhi1,ixGlo2:ixGhi2, 2))
  ...
  subroutine rhd_get_eigenjump(wL,wR,wroe,x,ixmin1,ixmin2,ixmax1,ixmax2,il,&
  ...
  subroutine geteigenjump2(wL,wR,wroe,x,ixmin1,ixmin2,ixmax1,ixmax2,il,idim,&
    ...
    if(il==1)then
       ...
       csound(ixmin1:ixmax1,ixmin2:ixmax2)=(rhd_gamma-one)*(wroe(ixmin1:ixmax1,&
          ixmin2:ixmax2,e_) - kin_en(ixmin1:ixmax1,ixmin2:ixmax2))
       ! Make sure that csound**2 is positive
       csound(ixmin1:ixmax1,ixmin2:ixmax2)=max(rhd_gamma*smalldouble/wroe(&
    ...
    case('harten','powell')
       ...
       if (il == soundRW_) then
          ...
          tmp(ixmin1:ixmax1,ixmin2:ixmax2)=wL(ixmin1:ixmax1,ixmin2:ixmax2,&
             ...
             rho_)+ sqrt(rhd_gamma*tmp(ixmin1:ixmax1,&
          ...
          tmp2(ixmin1:ixmax1,ixmin2:ixmax2)=wR(ixmin1:ixmax1,ixmin2:ixmax2,&
             ...
             rho_)+ sqrt(rhd_gamma*tmp2(ixmin1:ixmax1,&
  ...
  subroutine rhd_rtimes(q,wroe,ixmin1,ixmin2,ixmax1,ixmax2,iw,il,idim,rq,&
     workroe)
    use mod_global_parameters
  ...
  subroutine rhd_average_iso(wL,wR,x,ixmin1,ixmin2,ixmax1,ixmax2,idim,wroe,&
     workroe)
  ...
  subroutine rhd_get_eigenjump_iso(wL,wR,wroe,x,ixmin1,ixmin2,ixmax1,ixmax2,il,&
     idim,smalla,a,jump,workroe)
  ...
  subroutine geteigenjump2_iso(wL,wR,wroe,x,ixmin1,ixmin2,ixmax1,ixmax2,il,&
    ...
    select case (typeaverage)
    case ('arithmetic')
       call rhd_get_pthermal(wroe,x,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixmin1,ixmin2,&
          ixmax1,ixmax2,csound)
       csound(ixmin1:ixmax1,ixmin2:ixmax2) = &
          sqrt(rhd_gamma*csound(ixmin1:ixmax1,&
    ...
    case ('roe','default')
       ...
       elsewhere
          csound(ixmin1:ixmax1,ixmin2:ixmax2) =  &
             sqrt(rhd_gamma*(tmp2(ixmin1:ixmax1,&
             ixmin2:ixmax2)-tmp(ixmin1:ixmax1,&
             ixmin2:ixmax2))/(wR(ixmin1:ixmax1,ixmin2:ixmax2,&
  ...
  subroutine rhd_rtimes_iso(q,wroe,ixmin1,ixmin2,ixmax1,ixmax2,iw,il,idim,rq,&
     workroe)
