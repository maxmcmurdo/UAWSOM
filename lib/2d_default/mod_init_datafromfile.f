...
contains
  ...
  subroutine read_data_init()
    ...
    if(usr_filename/='')then
       ...
       do ivar = 1,bc%n_variables
          ...
          lt_2d(ivar) = LT2_create_from_data(bc%origin(1:ndim), xmax(1:ndim),&
              bc%values(:, :, 1:1, ivar))
  ...
  subroutine read_data_set(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
     ixOmax1,ixOmax2,x,val,nval)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImin2,ixImax1,ixImax2,&
        ixOmin1,ixOmin2,ixOmax1,ixOmax2, nval
    double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:ndim)
    double precision, intent(out)   :: val(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:nval)
    integer                         :: ival
    ...
    do ival=1,nval
       val(ixOmin1:ixOmax1, ixOmin2:ixOmax2, ival) = read_data_get_2d(ival,&
           x(ixOmin1:ixOmax1, ixOmin2:ixOmax2, 1), x(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2, 2))
    enddo
