...
contains
  ...
  subroutine gradient(q,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    x(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
       1:ndim)=block%x(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,1:ndim)
    ...
    case(cylindrical)
      if(idir==phi_) then
        gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ...
           jxOmin3:jxOmax3)-q(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
           hxOmin3:hxOmax3))/((x(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
           jxOmin3:jxOmax3,phi_)-x(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
           hxOmin3:hxOmax3,phi_))*x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3,r_))
      else
        gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)=(q(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
           jxOmin3:jxOmax3)-q(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
           hxOmin3:hxOmax3))/(x(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
           jxOmin3:jxOmax3,idir)-x(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
  ...
  subroutine gradientx(q,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
     ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idir,gradq,fourth_order)
    use mod_global_parameters
    ...
    integer                         :: jxOmin1,jxOmin2,jxOmin3,jxOmax1,jxOmax2,&
       jxOmax3, hxOmin1,hxOmin2,hxOmin3,hxOmax1,hxOmax2,hxOmax3, kxOmin1,&
       kxOmin2,kxOmin3,kxOmax1,kxOmax2,kxOmax3

    if(fourth_order) then
      ! Fourth order, stencil width is two
      kxOmin1=ixOmin1-2;kxOmin2=ixOmin2-2;kxOmin3=ixOmin3-2;kxOmax1=ixOmax1+2
      kxOmax2=ixOmax2+2;kxOmax3=ixOmax3+2;
      if(ixImin1>kxOmin1.or.ixImax1<kxOmax1.or.ixImin2>kxOmin2.or.&
         ixImax2<kxOmax2.or.ixImin3>kxOmin3.or.ixImax3<kxOmax3) call &
      ...
      kxOmin3=ixOmin3+kr(idir,3)*2;kxOmax1=ixOmax1+kr(idir,1)*2
      kxOmax2=ixOmax2+kr(idir,2)*2;kxOmax3=ixOmax3+kr(idir,3)*2;
    else
      hxOmin1=ixOmin1;hxOmin2=ixOmin2;hxOmin3=ixOmin3;hxOmax1=ixOmax1
      hxOmax2=ixOmax2;hxOmax3=ixOmax3;
    end if
    jxOmin1=ixOmin1+kr(idir,1);jxOmin2=ixOmin2+kr(idir,2)
    jxOmin3=ixOmin3+kr(idir,3);jxOmax1=ixOmax1+kr(idir,1)
    jxOmax2=ixOmax2+kr(idir,2);jxOmax3=ixOmax3+kr(idir,3);
    ...
    case(Cartesian)
      if(fourth_order) then
        gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)=(27.d0*(q(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
           jxOmin3:jxOmax3)-q(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3))-q(kxOmin1:kxOmax1,kxOmin2:kxOmax2,&
           kxOmin3:kxOmax3)+q(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
           hxOmin3:hxOmax3))/24.d0/dxlevel(idir)
      else
        gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)=(q(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
           jxOmin3:jxOmax3)-q(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
  ...
  subroutine gradientS(q,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
     ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idir,gradq)
    use mod_global_parameters
    use mod_limiter
    use mod_ppm
    ...
    integer, intent(in)                :: ixImin1,ixImin2,ixImin3,ixImax1,&
       ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, idir
    double precision, intent(in)       :: q(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3)
    double precision, intent(inout)    :: gradq(ixImin1:ixImax1,&
       ixImin2:ixImax2,ixImin3:ixImax3)
    double precision ,dimension(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3) :: qC,qL,qR,dqC,ldq,rdq
    ...
    if (type_gradient_limiter(block%level)/=limiter_ppm) then
      ...
      call PPMlimitervar(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idir,q,q,qL,qR)
    endif
    ...
    case(Cartesian)
      gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ...
         hxOmin3:hxOmax3))*invdx
    case(Cartesian_stretched,Cartesian_expansion)
      gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)=(qR(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)-qL(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
         hxOmin3:hxOmax3))/block%dx(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
    ...
    case(spherical)
      ...
      case(3)
        gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)=gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)/(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
           1)*dsin(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,2)))
    ...
    case(cylindrical)
      gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ...
         hxOmin3:hxOmax3))/block%dx(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,idir)
      if(idir==phi_) gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)=gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
  ...
  subroutine divvectorS(qvec,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    do idims=1,ndim
      ...
      if(type_gradient_limiter(block%level)/=limiter_ppm) then
        dqC(gxCmin1:gxCmax1,gxCmin2:gxCmax2,&
           gxCmin3:gxCmax3)= qR(gxCmin1:gxCmax1,gxCmin2:gxCmax2,&
           gxCmin3:gxCmax3)-qL(gxCmin1:gxCmax1,gxCmin2:gxCmax2,&
           gxCmin3:gxCmax3)
        call dwlimiter2(dqC,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
        ...
        qL(ixCmin1:ixCmax1,ixCmin2:ixCmax2,&
           ...
           ixCmin3:ixCmax3) + half*ldq(ixCmin1:ixCmax1,ixCmin2:ixCmax2,&
           ixCmin3:ixCmax3)
        qR(ixCmin1:ixCmax1,ixCmin2:ixCmax2,&
           ixCmin3:ixCmax3) = qR(ixCmin1:ixCmax1,ixCmin2:ixCmax2,&
           ixCmin3:ixCmax3) - half*rdq(jxCmin1:jxCmax1,jxCmin2:jxCmax2,&
           jxCmin3:jxCmax3)
      else
        dqC(ixImin1:ixImax1,ixImin2:ixImax2,&
           ixImin3:ixImax3)=qvec(ixImin1:ixImax1,ixImin2:ixImax2,&
           ixImin3:ixImax3,idims)
        call PPMlimitervar(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
           ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idims,dqC,dqC,qL,&
           qR)
      endif
  ...
  !>        use Gauss theorem for non-Cartesian grids
  !>        use Stokes theorem for non-Cartesian grids
  subroutine curlvector_trans(qvec,qvecc,ixImin1,ixImin2,ixImin3,ixImax1,&
     ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,curlvec,&
     idim,idirmin,idirmin0,ndir0)
    use mod_global_parameters
    ...
    integer, intent(inout)          :: idirmin
    double precision, intent(in)    :: qvec(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3,1:ndir0),qvecc(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3,1:ndir0)
    double precision, intent(inout) :: curlvec(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3,idirmin0:3)
    ...
    integer          :: ixAmin1,ixAmin2,ixAmin3,ixAmax1,ixAmax2,ixAmax3,&
       ixCmin1,ixCmin2,ixCmin3,ixCmax1,ixCmax2,ixCmax3,jxCmin1,jxCmin2,jxCmin3,&
       jxCmax1,jxCmax2,jxCmax3,idir,jdir,kdir,hxOmin1,hxOmin2,hxOmin3,hxOmax1,&
       hxOmax2,hxOmax3,jxOmin1,jxOmin2,jxOmin3,jxOmax1,jxOmax2,jxOmax3
    double precision :: invdx(1:ndim)
    double precision :: tmp(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       tmp2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       xC(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
          ...
          do jdir=1,ndim; do kdir=1,ndir0
            if(lvc(idir,jdir,kdir)/=0)then
              if(jdir/=idim) then
                ...
                tmp(ixImin1:ixImax1,ixImin2:ixImax2,&
                   ixImin3:ixImax3)=qvecc(ixImin1:ixImax1,ixImin2:ixImax2,&
                   ixImin3:ixImax3,kdir)
                hxOmin1=ixOmin1;hxOmin2=ixOmin2;hxOmin3=ixOmin3
                hxOmax1=ixOmax1;hxOmax2=ixOmax2;hxOmax3=ixOmax3;
                jxOmin1=ixOmin1+kr(jdir,1);jxOmin2=ixOmin2+kr(jdir,2)
                jxOmin3=ixOmin3+kr(jdir,3);jxOmax1=ixOmax1+kr(jdir,1)
                jxOmax2=ixOmax2+kr(jdir,2);jxOmax3=ixOmax3+kr(jdir,3);
              end if
              ! second order centered differencing
              tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                 ixOmin3:ixOmax3)=half*(tmp(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
                 jxOmin3:jxOmax3)-tmp(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
                 hxOmin3:hxOmax3))*invdx(jdir)
              if(lvc(idir,jdir,kdir)==1)then
                curlvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
                   idir)=curlvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
