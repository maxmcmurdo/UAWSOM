...
contains
  ...
  subroutine twofl_ppm_flatcd(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    if(twofl_eq_energy/=0) then
      drho(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) =twofl_gamma*dabs(d2w(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3,rho_c_))/min(w(ixLmin1:ixLmax1,&
         ixLmin2:ixLmax2,ixLmin3:ixLmax3,rho_c_),w(ixRmin1:ixRmax1,&
         ixRmin2:ixRmax2,ixRmin3:ixRmax3,rho_c_))
      dp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = dabs(d2w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,e_c_))/min(w(ixLmin1:ixLmax1,ixLmin2:ixLmax2,&
         ixLmin3:ixLmax3,e_c_),w(ixRmin1:ixRmax1,ixRmin2:ixRmax2,&
         ixRmin3:ixRmax3,e_c_))
    else
      call mpistop&
  ...
  subroutine twofl_ppm_flatsh(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    if(twofl_eq_energy/=0) then
      ...
      ptot(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)=w(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3,e_c_)+half*sum(w(ixOmin1:ixOmax1,&
      ...
      dp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)=(twofl_gamma*w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,e_c_)/w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
      ...
      dp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ...
         rho_c_)*dp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3))
      ! recycle ptot to store v
      ptot(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3)= w(ixImin1:ixImax1,&
         ixImin2:ixImax2,ixImin3:ixImax3,mom_c(idims))
