...
contains
  ...
  subroutine reconstruct(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    case (limiter_mp5)
       call MP5limitervar(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
          ixCmin1,ixCmin2,ixCmin3,ixCmax1,ixCmax2,ixCmax3,idir,q,qL,qR)
    case (limiter_weno3)
       call WENO3limiter(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
          ixCmin1,ixCmin2,ixCmin3,ixCmax1,ixCmax2,ixCmax3,idir,dxlevel(idir),q,&
          qL,qR,1)
    ...
    case (limiter_weno7)
       call WENO7limiter(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
          ixCmin1,ixCmin2,ixCmin3,ixCmax1,ixCmax2,ixCmax3,idir,q,qL,qR,1)
    case (limiter_mpweno7)
       call WENO7limiter(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
          ixCmin1,ixCmin2,ixCmin3,ixCmax1,ixCmax2,ixCmax3,idir,q,qL,qR,2)
    case (limiter_venk)
    ...
    case default
       dqC(gxCmin1:gxCmax1,gxCmin2:gxCmax2,&
          ...
          gxCmin3:gxCmax3)-qL(gxCmin1:gxCmax1,gxCmin2:gxCmax2,gxCmin3:gxCmax3)
