...
contains
  ...
  subroutine twofl_average(wL,wR,x,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,&
     idim,wroe,workroe)
    use mod_global_parameters
  ...
  subroutine average2(wL,wR,x,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,idim,&
    ...
    wroe(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
       rho_c_)=half*(wL(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
       rho_c_)+wR(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,rho_c_))
    do idir=1,ndir
      wroe(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
         mom_c(idir))=half*(wL(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
         mom_c(idir))/wL(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
         rho_c_)+wR(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
         mom_c(idir))/wR(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,rho_c_))
      wroe(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
    ...
    call twofl_get_pthermal_c(wL,x,ixGlo1,ixGlo2,ixGlo3,ixGhi1,ixGhi2,ixGhi3,&
       ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,afast)
    call twofl_get_pthermal_c(wR,x,ixGlo1,ixGlo2,ixGlo3,ixGhi1,ixGhi2,ixGhi3,&
       ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,aslow)

    if(twofl_eq_energy/=0) then
      wroe(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
         e_c_)=half*(afast(ixmin1:ixmax1,ixmin2:ixmax2,&
    ...
    rhodv(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=wR(ixmin1:ixmax1,&
       ixmin2:ixmax2,ixmin3:ixmax3,mom_c(idim))-wL(ixmin1:ixmax1,ixmin2:ixmax2,&
       ixmin3:ixmax3,mom_c(idim))-wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
       ixmin3:ixmax3,mom_c(idim))*(wR(ixmin1:ixmax1,ixmin2:ixmax2,&
       ixmin3:ixmax3,rho_c_)-wL(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
       rho_c_))
    ...
    if(twofl_eq_energy/=0) then
      csound2(ixmin1:ixmax1,ixmin2:ixmax2,&
         ixmin3:ixmax3)=twofl_gamma*wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
         ixmin3:ixmax3,e_c_)/wroe(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
         rho_c_)
    else
      csound2(ixmin1:ixmax1,ixmin2:ixmax2,&
         ixmin3:ixmax3)=twofl_gamma*twofl_adiab*wroe(ixmin1:ixmax1,&
         ixmin2:ixmax2,ixmin3:ixmax3,rho_c_)**(twofl_gamma-one)
    end if
    ...
    cfast(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=sum(wroe(ixmin1:ixmax1,&
       ...
       ixmin2:ixmax2,ixmin3:ixmax3,rho_c_)+csound2(ixmin1:ixmax1,ixmin2:ixmax2,&
       ixmin3:ixmax3)
    ...
    cslow(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=half*(cfast(ixmin1:ixmax1,&
       ...
       mag(idim))**2/wroe(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,rho_c_)))
    ...
    ! rho -> dsqrt(rho)
    wroe(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
       rho_c_)=dsqrt(wroe(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,rho_c_))
  ...
  subroutine twofl_get_eigenjump(wL,wR,wroe,x,ixmin1,ixmin2,ixmin3,ixmax1,&
  ...
  subroutine geteigenjump2(wL,wR,wroe,x,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,&
    ...
    if(il==fastRW_)then
       ...
       bdv(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=wroe(ixmin1:ixmax1,&
          ...
          ixmin2:ixmax2,ixmin3:ixmax3,mom_c(idir))/wR(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,rho_c_)-wL(ixmin1:ixmax1,ixmin2:ixmax2,&
          ixmin3:ixmax3,mom_c(idir))/wL(ixmin1:ixmax1,ixmin2:ixmax2,&
          ixmin3:ixmax3,rho_c_))
       if(ndir==3)bdv(ixmin1:ixmax1,ixmin2:ixmax2,&
          ...
          mom_c(jdir))/wR(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
          rho_c_)-wL(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
          mom_c(jdir))/wL(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,rho_c_))
       bdv(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=bdv(ixmin1:ixmax1,&
          ...
          ixmin3:ixmax3,rho_c_)**2,wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
    ...
    if(il==alfvRW_)then
       ...
       bdv(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=wroe(ixmin1:ixmax1,&
          ...
          ixmin2:ixmax2,ixmin3:ixmax3,rho_c_)-wL(ixmin1:ixmax1,ixmin2:ixmax2,&
          ixmin3:ixmax3,mom_c(idir))/wL(ixmin1:ixmax1,ixmin2:ixmax2,&
          ixmin3:ixmax3,rho_c_)) -wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          ixmin3:ixmax3,mag(idir))* (wR(ixmin1:ixmax1,ixmin2:ixmax2,&
          ixmin3:ixmax3,mom_c(jdir))/wR(ixmin1:ixmax1,ixmin2:ixmax2,&
          ixmin3:ixmax3,rho_c_)-wL(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
          mom_c(jdir))/wL(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,rho_c_))
       bdb(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=wroe(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,mag(jdir))*(wR(ixmin1:ixmax1,&
       ...
       bdv(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=bdv(ixmin1:ixmax1,&
          ...
          ixmin3:ixmax3,rho_c_)**2
       bdb(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=bdb(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3)*half*sign(wroe(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,rho_c_),wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
          ixmin3:ixmax3,mag(idim)))
    endif
    ...
    case(fastRW_)
       a(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=wroe(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,mom_c(idim))+cfast(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3)
    ...
    case(slowRW_)
       a(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=wroe(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,mom_c(idim))+cslow(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3)
       jump(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=half/csound2(&
    ...
    case(entroW_)
       a(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=wroe(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,mom_c(idim))
       jump(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=wR(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,rho_c_)-wL(ixmin1:ixmax1,ixmin2:ixmax2,&
          ixmin3:ixmax3,rho_c_)-dp(ixmin1:ixmax1,ixmin2:ixmax2,&
    ...
    case(alfvRW_)
       a(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=wroe(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,mom_c(idim))+dabs(wroe(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,mag(idim)))/wroe(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,rho_c_)
    ...
    case('harten','powell', 'ratio')
       ...
       aL(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)= wL(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,mom_c(idim))/wL(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,rho_c_)
       aR(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)= wR(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,mom_c(idim))/wR(ixmin1:ixmax1,&
          ixmin2:ixmax2,ixmin3:ixmax3,rho_c_)
       ...
       case(fastRW_)
          ...
          call twofl_get_csound2_c_from_conserved(wL,x,ixGlo1,ixGlo2,ixGlo3,&
             ixGhi1,ixGhi2,ixGhi3,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,&
             cs2L)
          call twofl_get_csound2_c_from_conserved(wR,x,ixGlo1,ixGlo2,ixGlo3,&
             ixGhi1,ixGhi2,ixGhi3,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,&
             cs2R)
          ...
          cs2L(ixmin1:ixmax1,ixmin2:ixmax2,&
             ...
             mag(idim))**2/wL(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
             rho_c_))
          cs2R(ixmin1:ixmax1,ixmin2:ixmax2,&
             ...
             mag(idim))**2/wR(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
             rho_c_))
  ...
  subroutine twofl_rtimes(q,w,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iw,il,&
     idim,rq,workroe)
    use mod_global_parameters
    ...
    if(iw == rho_c_) then
      ...
      if(il==fastRW_)then
        ...
        v2a2(ixmin1:ixmax1,ixmin2:ixmax2,&
           ...
           ixmin3:ixmax3,mom_c(:))**2,dim=ndim+1)+ &
        ...
        bv(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=wroe(ixmin1:ixmax1,&
           ixmin2:ixmax2,ixmin3:ixmax3,mag(idir))*wroe(ixmin1:ixmax1,&
           ixmin2:ixmax2,ixmin3:ixmax3,mom_c(idir))
        ...
        bv(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=(wroe(ixmin1:ixmax1,&
           ...
           ixmin2:ixmax2,ixmin3:ixmax3,mom_c(idir))-wroe(ixmin1:ixmax1,&
           ixmin2:ixmax2,ixmin3:ixmax3,mag(idir))*wroe(ixmin1:ixmax1,&
           ixmin2:ixmax2,ixmin3:ixmax3,mom_c(jdir)))
      endif
      ...
      case(entroW_)
        rq(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)= q(ixmin1:ixmax1,&
           ...
           ixmin2:ixmax2,ixmin3:ixmax3,mom_c(:))**2,dim=ndim+1)
      case(diverW_)
        if(divbwave)then
          rq(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)= q(ixmin1:ixmax1,&
             ixmin2:ixmax2,ixmin3:ixmax3)*wroe(ixmin1:ixmax1,ixmin2:ixmax2,&
      ...
      if(iw==mag(idim))then
        ...
        case(fastRW_,fastLW_)
          rq(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=+q(ixmin1:ixmax1,&
             ...
             ixmin3:ixmax3))*wroe(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,&
             iw)/wroe(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,rho_c_)
        case(slowRW_,slowLW_)
          rq(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3)=-q(ixmin1:ixmax1,&
             ixmin2:ixmax2,ixmin3:ixmax3)*afast(ixmin1:ixmax1,ixmin2:ixmax2,&
             ixmin3:ixmax3)*dsqrt(csound2(ixmin1:ixmax1,ixmin2:ixmax2,&
