...
module mod_thermal_emission
  ...
  abstract interface
    subroutine get_subr1(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
  ...
  contains
    ...
    subroutine get_EUV(wl,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
       ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,fl,flux)
      ...
      call fl%get_pthermal(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,pth)
      call fl%get_rho(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,Ne)
      if(associated(fl%get_var_Rfactor)) then
        call fl%get_var_Rfactor(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
           ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,Te)
        Te(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)=pth(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)/(Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
        ...
        Te(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)=pth(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)/(Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)*fl%Rfactor)*unit_temperature
      endif
      if (SI_unit) then
        Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)=Ne(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2,ixOmin3:ixOmax3)*unit_numberdensity/1.d6 !m-3,m-3,m-3 -> cm-3
        flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)=Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)**2
      else
        Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)=Ne(ixOmin1:ixOmax1,&
      ...
      ! temperature table in log
        ...
        do ix1=ixOmin1,ixOmax1
          ...
          if (logT>=t_table(1) .and. logT<=t_table(n_table)) then
            ...
            enddo
            flux(ix1,ix2,ix3)=flux(ix1,ix2,ix3)*(10**(logGT))
            if(flux(ix1,ix2,ix3)<smalldouble) flux(ix1,ix2,ix3)=0.d0
          else
            flux(ix1,ix2,ix3)=zero
          endif
        enddo
        enddo
        enddo
      ...
      ! temperature table linear
        ...
        do ix2=ixOmin2,ixOmax2
        do ix1=ixOmin1,ixOmax1
          if (Te(ix1,ix2,ix3)>=t_table(1) .and. Te(ix1,ix2,&
             ix3)<=t_table(n_table)) then
            do iTt=1,n_table-1
              if (Te(ix1,ix2,ix3)>=t_table(iTt) .and. Te(ix1,ix2,&
                 ix3)<t_table(iTt+1)) then
                GT=f_table(iTt)*(Te(ix1,ix2,&
                   ix3)-t_table(iTt+1))/(t_table(iTt)-t_table(iTt+1))+&
                   f_table(iTt+1)*(Te(ix1,ix2,&
                   ix3)-t_table(iTt))/(t_table(iTt+1)-t_table(iTt))
              endif
            enddo
            flux(ix1,ix2,ix3)=flux(ix1,ix2,ix3)*GT
            if(flux(ix1,ix2,ix3)<smalldouble) flux(ix1,ix2,ix3)=0.d0
          else
            flux(ix1,ix2,ix3)=zero
          endif
    ...
    subroutine get_SXR(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,&
       ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,fl,flux,El,Eu)
      ...
      integer :: ix1,ix2,ix3,ixO1,ixO2,ixO3
      integer :: iE,numE
      double precision :: I0,kb,keV,dE,Ei
      double precision :: pth(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         Te(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         kbT(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3)
      double precision :: Ne(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         gff(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         fi(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3)
      double precision :: EM(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3)
      ...
      if (SI_unit) then
        Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)=Ne(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2,ixOmin3:ixOmax3)*unit_numberdensity/1.d6 !m-3,m-3,m-3 -> cm-3
        EM(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)=(Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3))**2*1.d6 !cm-3,cm-3,cm-3 m-3,m-3,m-3
      else
        Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)=Ne(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2,ixOmin3:ixOmax3)*unit_numberdensity
        EM(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
      ...
      kbT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)=kb*Te(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)/keV
      flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)=0.0d0
      do iE=0,numE-1
        Ei=dE*iE+El*1.d0
        gff(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)=1.d0
        do ix3=ixOmin3,ixOmax3
        do ix2=ixOmin2,ixOmax2
        do ix1=ixOmin1,ixOmax1
          if (kbT(ix1,ix2,ix3)>0.01*Ei) then
            if(kbT(ix1,ix2,ix3)<Ei) gff(ix1,ix2,ix3)=(kbT(ix1,ix2,&
               ix3)/Ei)**0.4
            fi(ix1,ix2,ix3)=(EM(ix1,ix2,ix3)*gff(ix1,ix2,&
               ix3))*dexp(-Ei/(kbT(ix1,ix2,ix3)))/(Ei*dsqrt(kbT(ix1,ix2,ix3)))
          else
            fi(ix1,ix2,ix3)=zero
          endif
        enddo
        ...
        enddo
        flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)=flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)+fi(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)*dE
      enddo
      flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)=flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
    ...
    subroutine get_GOES_SXR_flux(xboxmin1,xboxmin2,xboxmin3,xboxmax1,xboxmax2,&
       xboxmax3,fl,eflux)
      !get GOES SXR 1-8A flux observing at 1AU from given box [w/m^2]
      use mod_global_parameters

      double precision, intent(in) :: xboxmin1,xboxmin2,xboxmin3,xboxmax1,&
         xboxmax2,xboxmax3
      type(te_fluid), intent(in) :: fl
      ...
      integer :: ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,ixImin1,&
         ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ix1,ix2,ix3
      ...
      do iigrid=1,igridstail; igrid=igrids(iigrid);
        ...
        call get_GOES_flux_grid(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
           ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,ps(igrid)%w,&
           ps(igrid)%x,ps(igrid)%dvolume(ixImin1:ixImax1,ixImin2:ixImax2,&
           ixImin3:ixImax3),xboxmin1,xboxmin2,xboxmin3,xboxmax1,xboxmax2,&
           xboxmax3,xbmin1,xbmin2,xbmin3,xbmax1,xbmax2,xbmax3,fl,eflux_grid)
    ...
    subroutine get_GOES_flux_grid(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,dV,xboxmin1,&
       xboxmin2,xboxmin3,xboxmax1,xboxmax2,xboxmax3,xbmin1,xbmin2,xbmin3,&
       xbmax1,xbmax2,xbmax3,fl,eflux_grid)
      use mod_global_parameters

      integer, intent(in)           :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
         ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3
      double precision, intent(in)  :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,1:ndim),dV(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3)
      double precision, intent(in)  :: w(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,nw)
      double precision, intent(in)  :: xboxmin1,xboxmin2,xboxmin3,xboxmax1,&
         xboxmax2,xboxmax3,xbmin1,xbmin2,xbmin3,xbmax1,xbmax2,xbmax3
      type(te_fluid), intent(in) :: fl
      double precision, intent(out) :: eflux_grid

      integer :: ix1,ix2,ix3,ixO1,ixO2,ixO3,ixbmin1,ixbmin2,ixbmin3,ixbmax1,&
         ixbmax2,ixbmax3
      ...
      double precision :: pth(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         ...
         kbT(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3)
      double precision :: Ne(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         EM(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3)
      ...
      if (xbmin2<xboxmax2 .and. xbmax2>xboxmin2) inbox=inbox+1
      if (xbmin3<xboxmax3 .and. xbmax3>xboxmin3) inbox=inbox+1

      if (inbox==ndim) then
        ! indexes for cells inside given box
        ixbmin1=ixOmin1;ixbmin2=ixOmin2;ixbmin3=ixOmin3;
        ixbmax1=ixOmax1;ixbmax2=ixOmax2;ixbmax3=ixOmax3;
        if (xbmax1>xboxmax1) ixbmax1=ixOmax1-ceiling((xbmax1-&
           xboxmax1)/dxlevel(1))
        if (xbmax2>xboxmax2) ixbmax2=ixOmax2-ceiling((xbmax2-&
           xboxmax2)/dxlevel(2))
        if (xbmax3>xboxmax3) ixbmax3=ixOmax3-ceiling((xbmax3-&
           xboxmax3)/dxlevel(3))
        if (xbmin1<xboxmin1) ixbmin1=ceiling((xboxmin1-xbmin1)/dxlevel(1))+&
           ixOmin1
        if (xbmin2<xboxmin2) ixbmin2=ceiling((xboxmin2-xbmin2)/dxlevel(2))+&
           ixOmin2
        if (xbmin3<xboxmin3) ixbmin3=ceiling((xboxmin3-xbmin3)/dxlevel(3))+&
           ixOmin3

        I0=1.07d-38 !photon flux index for observed at 1AU [photon cm3,cm3,cm3 m-2,m-2,m-2 s-1,s-1,s-1 keV-1],keV-1],keV-1]
        kb=const_kb
        keV=1.0d3*const_ev
        erg_SI=1.d-7
        ...
        dE=0.1  ! keV
        numE=floor((Eu-El)/dE)
        call fl%get_pthermal(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
           ixImax3,ixbmin1,ixbmin2,ixbmin3,ixbmax1,ixbmax2,ixbmax3,pth)
        call fl%get_rho(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
           ixbmin1,ixbmin2,ixbmin3,ixbmax1,ixbmax2,ixbmax3,Ne)
        if(associated(fl%get_var_Rfactor)) then
          call fl%get_var_Rfactor(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
             ixImax3,ixbmin1,ixbmin2,ixbmin3,ixbmax1,ixbmax2,ixbmax3,Te)
          Te(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3)=pth(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3)/(Ne(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3)*Te(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3))*unit_temperature
        else
          Te(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3)=pth(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3)/(Ne(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3)*fl%Rfactor)*unit_temperature
        endif
        if (SI_unit) then
          Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             ixOmin3:ixOmax3)=Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             ixOmin3:ixOmax3)*unit_numberdensity/1.d6 !m-3,m-3,m-3 -> cm-3
          EM(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3)=(I0*(Ne(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3))**2)*dV(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3)*(unit_length*1.d2)**3 !cm-3,cm-3,cm-3
        else
          Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             ixOmin3:ixOmax3)=Ne(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             ixOmin3:ixOmax3)*unit_numberdensity
          EM(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3)=(I0*(Ne(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3))**2)*dV(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
             ixbmin3:ixbmax3)*unit_length**3
        endif
        kbT(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
           ixbmin3:ixbmax3)=kb*Te(ixbmin1:ixbmax1,ixbmin2:ixbmax2,&
           ixbmin3:ixbmax3)/keV
        eflux_grid=0.0d0

        do iE=0,numE-1
          Ei=dE*iE+El
          do ix3=ixbmin3,ixbmax3
          do ix2=ixbmin2,ixbmax2
          do ix1=ixbmin1,ixbmax1
            if (kbT(ix1,ix2,ix3)>1.d-2*Ei) then
              if(kbT(ix1,ix2,ix3)<Ei) then
                gff=(kbT(ix1,ix2,ix3)/Ei)**0.4
              else
                gff=1.d0
              endif
              fi=(EM(ix1,ix2,ix3)*gff)*dexp(-Ei/(kbT(ix1,ix2,&
                 ix3)))/(Ei*dsqrt(kbT(ix1,ix2,ix3)))
    ...
    subroutine get_EUV_spectrum(qunit,fl)
      ...
      call get_line_info(spectrum_wl,ion,mass,logTe,lineCent,spaceRsl,wlRsl,&
         sigma_PSF,wslit)
      if (mype==0) write(*,'(a,f8.3,a)') ' Wavelength: ',lineCent,' Angstrom'
      if (mype==0) print *, 'Unit of EUV flux: DN s^-1 pixel^-1'
      if (mype==0) write(*,'(a,f5.3,a,f5.1,a)') ' Pixel: ',wlRsl,&
         ' Angstrom x ',spaceRsl*725.0, ' km'
      ...
      if (resolution_spectrum=='data') then
        ...
        if (mype==0) write(*,'(a,f8.1,a)') ' Unit of length: ',&
           unit_length/1.d8,' Mm'
        if (SI_unit) then
          if (mype==0) write(*,'(a,f8.1,a)') ' Location of slit: ',&
             location_slit*unit_length/1.d6,' Mm'
        else
          if (mype==0) write(*,'(a,f8.1,a)') ' Location of slit: ',&
             location_slit*unit_length/1.d8,' Mm'
        endif
        if (mype==0) write(*,'(a,f8.1,a)') ' Width of slit: ',wslit*725.0,&
           ' km'
        ...
        if (mype==0) write(*,'(a,f8.1,a)') ' Location of slit: xI1 = ',&
           location_slit,' arcsec'
    ...
    subroutine get_spectrum_inst_resol(qunit,datatype,fl)
      ...
      integer :: numWL,numXS,iwL,ixS,numWI,ix1,ix2,ix3
      ...
      numWI=1
      allocate(wI(numWL,numXS,numWI),spectra(numWL,numXS),spectra_rc(numWL,&
         numXS))
      do iWL=1,numWL
      ...
      do iigrid=1,igridstail; igrid=igrids(iigrid);
        ...
        if (xslit>=xLmin-wslit*arcsec .and. xslit<=xLmax+wslit*arcsec) then
          call integrate_spectra_inst_resol(igrid,wL,dwLg,xS,dxSg,spectra,&
             numWL,numXS,fl)
        endif
      enddo

      numS=numWL*numXS
      call MPI_ALLREDUCE(spectra,spectra_rc,numS,MPI_DOUBLE_PRECISION, MPI_SUM,&
         icomm,ierrmpi)
      do iwL=1,numWL
        do ixS=1,numXS
    ...
    subroutine integrate_spectra_inst_resol(igrid,wL,dwLg,xS,dxSg,spectra,&
       numWL,numXS,fl)
      ...
      integer :: ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,ixImin1,&
         ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ix1,ix2,ix3,ixOnew,j
      double precision, allocatable :: flux(:,:,:),v(:,:,:),pth(:,:,:),Te(:,:,&
         :),rho(:,:,:)
      double precision :: wlc,wlwd,res,dst_slit,xslit,arcsec
      double precision :: vloc(1:3),xloc(1:3),dxloc(1:3),xIloc(1:2),&
         dxIloc(1:2)
      integer :: nSubC1,nSubC2,nSubC3,iSubC1,iSubC2,iSubC3,iwL,ixS,ixSmin,&
         ixSmax,iwLmin,iwLmax,nwL
      double precision :: slit_width,dxSubC1,dxSubC2,dxSubC3,xerfmin1,xerfmin2,&
         xerfmin3,xerfmax1,xerfmax2,xerfmax3,fluxSubC
  ...
  ixImax2=ixghi2
  ixImax3=ixghi3
      allocate(flux(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
      ...
      call get_EUV(spectrum_wl,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,ps(igrid)%w,&
         ps(igrid)%x,fl,flux)
      call fl%get_pthermal(ps(igrid)%w,ps(igrid)%x,ixImin1,ixImin2,ixImin3,&
         ixImax1,ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,&
         ixOmax3,pth)
      call fl%get_rho(ps(igrid)%w,ps(igrid)%x,ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,rho)
      if(associated(fl%get_var_Rfactor)) then
        call fl%get_var_Rfactor(ps(igrid)%w,ps(igrid)%x,ixImin1,ixImin2,&
        ...
        Te(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)=pth(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)/(fl%Rfactor*rho(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3))
      endif
      do ix1=ixOmin1,ixOmax1
  do ix2=ixOmin2,ixOmax2
  do ix3=ixOmin3,ixOmax3
        do j=1,3
          vloc(j)=ps(igrid)%w(ix1,ix2,ix3,iw_mom(j))/rho(ix1,ix2,ix3)
        enddo
  ...
  do ix2=ixOmin2,ixOmax2
  do ix3=ixOmin3,ixOmax3
        xloc(1:3)=ps(igrid)%x(ix1,ix2,ix3,1:3)
        dxloc(1:3)=ps(igrid)%dx(ix1,ix2,ix3,1:3)
        ...
        if (xIloc(1)>=xslit-half*(slit_width+dxIloc(1)) .and. &
          ...
          nSubC1=1;nSubC2=1;nSubC3=1;
          nSubC1=max(nSubC1,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
             1)*abs(vec_xI1(1))/(slit_width/16.d0)))
          nSubC2=max(nSubC2,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
             2)*abs(vec_xI1(2))/(slit_width/16.d0)))
          nSubC3=max(nSubC3,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
             3)*abs(vec_xI1(3))/(slit_width/16.d0)));
          nSubC1=max(nSubC1,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
             1)*abs(vec_xI2(1))/(dxSg/4.d0)))
          nSubC2=max(nSubC2,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
             2)*abs(vec_xI2(2))/(dxSg/4.d0)))
          nSubC3=max(nSubC3,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
             3)*abs(vec_xI2(3))/(dxSg/4.d0)));
          dxSubC1=ps(igrid)%dx(ix1,ix2,ix3,1)/nSubC1
          dxSubC2=ps(igrid)%dx(ix1,ix2,ix3,2)/nSubC2
          dxSubC3=ps(igrid)%dx(ix1,ix2,ix3,3)/nSubC3;
          ! local line center and line width
          if (SI_unit) then
            fluxSubC=flux(ix1,ix2,ix3&
               )*dxSubC1*dxSubC2*dxSubC3*unit_length*1.d2/dxSg/dxSg !DN s-1,s-1,s-1
            wlc=lineCent*(1.d0+v(ix1,ix2,ix3)*unit_velocity*1.d2/const_c)
          else
            fluxSubC=flux(ix1,ix2,ix3&
               )*dxSubC1*dxSubC2*dxSubC3*unit_length/dxSg/dxSg !DN s-1,s-1,s-1
            wlc=lineCent*(1.d0+v(ix1,ix2,ix3)*unit_velocity/const_c)
          endif
          wlwd=sqrt(kb_cgs*Te(ix1,ix2,ix3)*unit_temperature/(mass*mp_cgs))
          wlwd=wlwd*lineCent/const_c
 !dividing a cell to several parts to get more accurate integrating values
          do iSubC1=1,nSubC1
  do iSubC2=1,nSubC2
  do iSubC3=1,nSubC3
            xSubC(1)=xloc(1)-half*dxloc(1)+(iSubC1-half)*dxSubC1
            xSubC(2)=xloc(2)-half*dxloc(2)+(iSubC2-half)*dxSubC2
            xSubC(3)=xloc(3)-half*dxloc(3)+(iSubC3-half)*dxSubC3;
            ...
            if (dst_slit<=half*slit_width) then
              ...
              do iwL=iwLmin,iwLmax
                do ixS=ixSmin,ixSmax
                  xerfmin1=(wL(iwL)-half*dwLg-wlc)/sqrt(2.d0*(sigma_wl**2+&
                     wlwd**2))
                  xerfmax1=(wL(iwL)+half*dwLg-wlc)/sqrt(2.d0*(sigma_wl**2+&
                     wlwd**2))
                  xerfmin2=(xS(ixS)-half*dxSg-xCent(2))/(sqrt(2.d0)*sigma_xs)
                  xerfmax2=(xS(ixS)+half*dxSg-xCent(2))/(sqrt(2.d0)*sigma_xs)
                  factor=(erfc(xerfmin1)-erfc(xerfmax1))*(erfc(xerfmin2)-&
                     erfc(xerfmax2))/4.d0
  ...
  enddo
    ...
    subroutine get_spectrum_data_resol(qunit,datatype,fl)
      ...
      allocate(xS(numXS),dxS(numXS),spectra(numWL,numXS),spectra_rc(numWL,&
         numXS))
      numWI=1
      ...
      case(2) ! symm stretch
        ...
        do ixS=nstr,1,-1
          ...
          xS(ixS)=xSmin+lenstr-dxS(ixS)*half-dxfirst*(one-qs**(nstr-ixS))/(one-&
             qs)
        enddo
        ! right half
        do ixS=nstr+nuni+1,numXS
          dxS(ixS)=dxfirst*qs**(ixS-nstr-nuni-1)
          xS(ixS)=xSmax-lenstr+dxS(ixS)*half+&
             dxfirst*(one-qs**(ixS-nstr-nuni-1))/(one-qs)
        enddo
      case default
      ...
      spectra=zero
      do iigrid=1,igridstail; igrid=igrids(iigrid);
        xbmin(1)=rnode(rpxmin1_,igrid);xbmin(2)=rnode(rpxmin2_,igrid)
        xbmin(3)=rnode(rpxmin3_,igrid);
        xbmax(1)=rnode(rpxmax1_,igrid);xbmax(2)=rnode(rpxmax2_,igrid)
        xbmax(3)=rnode(rpxmax3_,igrid);
        if (location_slit>=xbmin(dir_loc) .and. location_slit<xbmax(dir_loc)) &
           then
          call integrate_spectra_data_resol(igrid,wL,dwL,spectra,numWL,numXS,&
             dir_loc,fl)
        endif
      enddo
    ...
    subroutine integrate_spectra_data_resol(igrid,wL,dwL,spectra,numWL,numXS,&
       dir_loc,fl)
      use mod_constants
      ...
      integer :: ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,ixImin1,&
         ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ix1,ix2,ix3,ixOnew
      double precision, allocatable :: flux(:,:,:),v(:,:,:),pth(:,:,:),Te(:,:,&
         :),rho(:,:,:)
  ...
  ixImax3=ixghi3
      ...
      ix1=ixOmin1;ix2=ixOmin2;ix3=ixOmin3;
      if (dir_loc==1) then
        do ix1=ixOmin1,ixOmax1
          if (location_slit>=(ps(igrid)%x(ix1,ix2,ix3,1)-half*ps(igrid)%dx(ix1,&
             ix2,ix3,1)) .and. location_slit<(ps(igrid)%x(ix1,ix2,ix3,&
             1)+half*ps(igrid)%dx(ix1,ix2,ix3,1))) then
            ixOnew=ix1
          endif
        enddo
        ixOmin1=ixOnew
        ...
        do ix2=ixOmin2,ixOmax2
          if (location_slit>=(ps(igrid)%x(ix1,ix2,ix3,2)-half*ps(igrid)%dx(ix1,&
             ix2,ix3,2)) .and. location_slit<(ps(igrid)%x(ix1,ix2,ix3,&
             2)+half*ps(igrid)%dx(ix1,ix2,ix3,2))) then
            ixOnew=ix2
          endif
        enddo
        ixOmin2=ixOnew
        ...
        do ix3=ixOmin3,ixOmax3
          if (location_slit>=(ps(igrid)%x(ix1,ix2,ix3,3)-half*ps(igrid)%dx(ix1,&
             ix2,ix3,3)) .and. location_slit<(ps(igrid)%x(ix1,ix2,ix3,&
             3)+half*ps(igrid)%dx(ix1,ix2,ix3,3))) then
            ixOnew=ix3
          endif
        enddo
        ixOmin3=ixOnew
      ...
      v(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)=-&
         ...
         iw_mom(direction_LOS))/rho(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)
      call fl%get_pthermal(ps(igrid)%w,ps(igrid)%x,ixImin1,ixImin2,ixImin3,&
         ixImax1,ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,&
         ixOmax3,pth)
  ...
  do ix3=ixOmin3,ixOmax3
        ...
        case(1)
          dL=ps(igrid)%dx(ix1,ix2,ix3,1)*unit_length
        case(2)
          dL=ps(igrid)%dx(ix1,ix2,ix3,2)*unit_length
        case default
          dL=ps(igrid)%dx(ix1,ix2,ix3,3)*unit_length
        end select
        if (SI_unit) dL=dL*1.d2

        do iwL=1,numWL
          flux_pix=flux(ix1,ix2,ix3)*wlRsl*dL*exp(-(wL(iwL)-&
             wlc)**2/(2*wlwd**2))/(sqrt(2*dpi)*wlwd)
  ...
  enddo
    ...
    subroutine get_EUV_image(qunit,fl)
      ...
      call get_line_info(wavelength,ion,mass,logTe,lineCent,spaceRsl,wlRsl,&
         sigma_PSF,wslit)
      if (mype==0) print *,&
          '###################################################'
      ...
      if (mype==0) write(*,'(a,f8.3,a)') ' Wavelength: ',lineCent,' Angstrom'
      if (mype==0) print *, 'Unit of EUV flux: DN s^-1 pixel^-1'
      if (mype==0) write(*,'(a,f5.1,a,f5.1,a)') ' Pixel: ',spaceRsl*725.0,&
         ' km x ',spaceRsl*725.0, ' km'
      if (mype==0) write(*,'(a,f6.3,f8.3,f8.3,a)') ' Mapping: [',x_origin(1),&
         x_origin(2),x_origin(3),&
    ...
    subroutine get_SXR_image(qunit,fl)
      ...
      if (mype==0) write(*,'(a,i2,a,i2,a)') ' Passband: ',emin_sxr,' - ',&
         emax_sxr,' keV'
      if (mype==0) print *, 'Unit of SXR flux: photons cm^-2 s^-1 pixel^-1'
      if (mype==0) write(*,'(a,f6.1,a,f6.1,a)') ' Pixel: ',2.3*725.0,' km x ',&
         2.3*725.0, ' km'
      if (mype==0) write(*,'(a,f6.3,f8.3,f8.3,a)') ' Mapping: [',x_origin(1),&
         x_origin(2),x_origin(3),&
          '] of the simulation box is located at [X=0,Y=0] of the image'
    ...
    subroutine get_image_inst_resol(qunit,datatype,fl)
      ...
      integer :: ix1,ix2,ix3,numXI1,numXI2,numWI
      ...
      if (datatype=='image_euv') then
        ...
        Dpls=zero
        do iigrid=1,igridstail; igrid=igrids(iigrid);
          call integrate_EUV_inst_resol(igrid,numXI1,numXI2,xI1,xI2,dxI,fl,&
             EUVs,Dpls)
        enddo
        numSI=numXI1*numXI2
        call MPI_ALLREDUCE(EUVs,EUV,numSI,MPI_DOUBLE_PRECISION, MPI_SUM,icomm,&
           ierrmpi)
        call MPI_ALLREDUCE(Dpls,Dpl,numSI,MPI_DOUBLE_PRECISION, MPI_SUM,icomm,&
           ierrmpi)
        do ix1=1,numXI1
          do ix2=1,numXI2
        ...
        xI2=xI2/arcsec
        dxI2=dxI2/arcsec
        call output_data(qunit,xI1,xI2,dxI1,dxI2,wI,numXI1,numXI2,numWI,&
           datatype)
      ...
      if (datatype=='image_sxr') then
        ...
        SXRs=zero
        do iigrid=1,igridstail; igrid=igrids(iigrid);
          call integrate_SXR_inst_resol(igrid,numXI1,numXI2,xI1,xI2,dxI,fl,&
             SXRs)
        enddo
        numSI=numXI1*numXI2
        call MPI_ALLREDUCE(SXRs,SXR,numSI,MPI_DOUBLE_PRECISION, MPI_SUM,icomm,&
           ierrmpi)
    ...
    subroutine integrate_SXR_inst_resol(igrid,numXI1,numXI2,xI1,xI2,dxI,fl,&
       SXR)
      ...
      integer :: ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,ixO1,ixO2,&
         ixO3,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ix1,ix2,ix3,i,j
      double precision :: xbmin1,xbmin2,xbmin3,xbmax1,xbmax2,xbmax3,xd1,xd2,&
         xd3
      double precision, allocatable :: flux(:,:,:)
      double precision :: vloc(1:3),res
      integer :: ixPmin1,ixPmin2,ixPmin3,ixPmax1,ixPmax2,ixPmax3,ixP1,ixP2,&
         ixP3,nSubC1,nSubC2,nSubC3,iSubC1,iSubC2,iSubC3
      double precision :: xSubP1,xSubP2,dxSubP,xerfmin1,xerfmin2,xerfmin3,&
         xerfmax1,xerfmax2,xerfmax3,fluxsubC
      double precision :: xSubC(1:3),dxSubC1,dxSubC2,dxSubC3,xCent(1:2)
  ...
  xbmax3=rnode(rpxmax3_,igrid)
      ...
      allocate(flux(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3))
      ! get local SXR flux
      call get_SXR(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,&
         ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,ps(igrid)%w,ps(igrid)%x,fl,&
         flux,emin_sxr,emax_sxr)
  ...
  do ix3=ixOmin3,ixOmax3
        nSubC1=1;nSubC2=1;nSubC3=1;
        nSubC1=max(nSubC1,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           1)*abs(vec_xI1(1))/(dxI/4.d0)))
        nSubC2=max(nSubC2,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           2)*abs(vec_xI1(2))/(dxI/4.d0)))
        nSubC3=max(nSubC3,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           3)*abs(vec_xI1(3))/(dxI/4.d0)));
        nSubC1=max(nSubC1,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           1)*abs(vec_xI2(1))/(dxI/4.d0)))
        nSubC2=max(nSubC2,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           2)*abs(vec_xI2(2))/(dxI/4.d0)))
        nSubC3=max(nSubC3,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           3)*abs(vec_xI2(3))/(dxI/4.d0)));
        dxSubC1=ps(igrid)%dx(ix1,ix2,ix3,1)/nSubC1
        dxSubC2=ps(igrid)%dx(ix1,ix2,ix3,2)/nSubC2
        dxSubC3=ps(igrid)%dx(ix1,ix2,ix3,3)/nSubC3;
 !dividing a cell to several parts to get more accurate integrating values
  ...
  do iSubC2=1,nSubC2
  do iSubC3=1,nSubC3
          xSubC(1)=ps(igrid)%x(ix1,ix2,ix3,1)-half*ps(igrid)%dx(ix1,ix2,ix3,&
             1)+(iSubC1-half)*dxSubC1
          xSubC(2)=ps(igrid)%x(ix1,ix2,ix3,2)-half*ps(igrid)%dx(ix1,ix2,ix3,&
             2)+(iSubC2-half)*dxSubC2
          xSubC(3)=ps(igrid)%x(ix1,ix2,ix3,3)-half*ps(igrid)%dx(ix1,ix2,ix3,&
             3)+(iSubC3-half)*dxSubC3;
          fluxSubC=flux(ix1,ix2,ix3)*dxSubC1*dxSubC2*dxSubC3*unit_length**&
             3/area_1AU
  ...
  enddo !ix
    ...
    subroutine integrate_EUV_inst_resol(igrid,numXI1,numXI2,xI1,xI2,dxI,fl,EUV,&
       Dpl)
      integer, intent(in) :: igrid,numXI1,numXI2
      double precision, intent(in) :: xI1(numXI1),xI2(numXI2)
      double precision, intent(in) :: dxI
      ...
      double precision :: xbmin1,xbmin2,xbmin3,xbmax1,xbmax2,xbmax3,xd1,xd2,&
         xd3
      double precision, allocatable :: flux(:,:,:),v(:,:,:),rho(:,:,:)
      double precision :: vloc(1:3),res
      integer :: ixPmin1,ixPmin2,ixPmin3,ixPmax1,ixPmax2,ixPmax3,ixP1,ixP2,&
         ixP3,nSubC1,nSubC2,nSubC3,iSubC1,iSubC2,iSubC3
      double precision :: xSubP1,xSubP2,dxSubP,xerfmin1,xerfmin2,xerfmin3,&
  ...
  xbmax3=rnode(rpxmax3_,igrid)
      ...
      allocate(flux(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         ...
         rho(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3))
      ! get local EUV flux and velocity
      call get_EUV(wavelength,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,ps(igrid)%w,&
         ps(igrid)%x,fl,flux)
      call fl%get_rho(ps(igrid)%w,ps(igrid)%x,ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,rho)
  ...
  do ix3=ixOmin3,ixOmax3
        nSubC1=1;nSubC2=1;nSubC3=1;
        nSubC1=max(nSubC1,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           1)*abs(vec_xI1(1))/(dxI/2.d0)))
        nSubC2=max(nSubC2,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           2)*abs(vec_xI1(2))/(dxI/2.d0)))
        nSubC3=max(nSubC3,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           3)*abs(vec_xI1(3))/(dxI/2.d0)));
        nSubC1=max(nSubC1,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           1)*abs(vec_xI2(1))/(dxI/2.d0)))
        nSubC2=max(nSubC2,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           2)*abs(vec_xI2(2))/(dxI/2.d0)))
        nSubC3=max(nSubC3,ceiling(ps(igrid)%dx(ix1,ix2,ix3,&
           3)*abs(vec_xI2(3))/(dxI/2.d0)));
        dxSubC1=ps(igrid)%dx(ix1,ix2,ix3,1)/nSubC1
        dxSubC2=ps(igrid)%dx(ix1,ix2,ix3,2)/nSubC2
        dxSubC3=ps(igrid)%dx(ix1,ix2,ix3,3)/nSubC3;
        if (SI_unit) then
          fluxSubC=flux(ix1,ix2,ix3&
             )*dxSubC1*dxSubC2*dxSubC3*unit_length*1.d2/dxI/dxI !DN s-1,s-1,s-1
        else
          fluxSubC=flux(ix1,ix2,ix3&
             )*dxSubC1*dxSubC2*dxSubC3*unit_length/dxI/dxI !DN s-1,s-1,s-1
        endif
 !dividing a cell to several parts to get more accurate integrating values
        do iSubC1=1,nSubC1
  do iSubC2=1,nSubC2
  do iSubC3=1,nSubC3
          ...
          do ixP1=ixPmin1,ixPmax1
            do ixP2=ixPmin2,ixPmax2
              ...
              Dpl(ixP1,ixP2)=Dpl(ixP1,ixP2)+fluxSubC*factor*v(ix1,ix2,ix3)
            enddo !ixP2
          enddo !ixP1
        enddo
  enddo
  ...
  enddo !ix
    ...
    subroutine get_image_data_resol(qunit,datatype,fl)
      ...
      integer :: numX1,numX2,numX3,ix1,ix2,ix3
      ...
      double precision :: xImin1,xImin2,xImin3,xImax1,xImax2,xImax3
      integer :: iigrid,igrid,i,j
      double precision, allocatable :: xIF1(:),xIF2(:),dxIF1(:),dxIF2(:)
      integer :: nXIF1,nXIF2
      double precision :: xIFmin1,xIFmin2,xIFmin3,xIFmax1,xIFmax2,xIFmax3

      double precision :: unitv,arcsec,RHESSI_rsl
      integer :: strtype1,strtype2,strtype3,nstrb1,nstrb2,nstrb3,nbb1,nbb2,&
         nbb3,nuni1,nuni2,nuni3,nstr1,nstr2,nstr3,bnx1,bnx2,bnx3
      double precision :: qs1,qs2,qs3,dxfirst1,dxfirst2,dxfirst3,dxmid1,dxmid2,&
         dxmid3,lenstr1,lenstr2,lenstr3
      ...
      case(2) ! symm stretch
        ...
        dxfirst1=(xIFmax1-xIFmin1)/(dble(nuni1)+&
           2.d0/(one-qs1)*(one-qs1**nstr1))
        dxmid1=dxfirst1
        ! refine_max level, numXI = nstr + nuni + nstr
        ...
        do ix1=nstr1,1,-1
          ...
          xIF1(ix1)=xIFmin1+lenstr1-dxIF1(ix1)*half-dxfirst1*(one-qs1**(nstr1-&
             ix1))/(one-qs1)
        enddo
        ! right half
        do ix1=nstr1+nuni1+1,nXIF1
          dxIF1(ix1)=dxfirst1*qs1**(ix1-nstr1-nuni1-1)
          xIF1(ix1)=xIFmax1-lenstr1+dxIF1(ix1)*half+&
             dxfirst1*(one-qs1**(ix1-nstr1-nuni1-1))/(one-qs1)
        enddo
      case default
        call mpistop("unknown stretch type")
      end select
      ...
      case(2) ! symm stretch
        ...
        dxfirst2=(xIFmax2-xIFmin2)/(dble(nuni2)+&
           2.d0/(one-qs2)*(one-qs2**nstr2))
        dxmid2=dxfirst2
        ! refine_max level, numXI = nstr + nuni + nstr
        ...
        do ix2=nstr2,1,-1
          ...
          xIF2(ix2)=xIFmin2+lenstr2-dxIF2(ix2)*half-dxfirst2*(one-qs2**(nstr2-&
             ix2))/(one-qs2)
        enddo
        ! right half
        do ix2=nstr2+nuni2+1,nXIF2
          dxIF2(ix2)=dxfirst2*qs2**(ix2-nstr2-nuni2-1)
          xIF2(ix2)=xIFmax2-lenstr2+dxIF2(ix2)*half+&
             dxfirst2*(one-qs2**(ix2-nstr2-nuni2-1))/(one-qs2)
        enddo
      case default
        call mpistop("unknown stretch type")
      end select
      ...
      if (datatype=='image_euv') then
        ...
        Dpls=0.d0 
        do iigrid=1,igridstail; igrid=igrids(iigrid);
          call integrate_EUV_data_resol(igrid,nXIF1,nXIF2,xIF1,xIF2,dxIF1,&
             dxIF2,fl,EUVs,Dpls)
        enddo
        numSI=nXIF1*nXIF2
        call MPI_ALLREDUCE(EUVs,EUV,numSI,MPI_DOUBLE_PRECISION, MPI_SUM,icomm,&
        ...
        call output_data(qunit,xIF1,xIF2,dxIF1,dxIF2,wI,nXIF1,nXIF2,numWI,&
           datatype)
        deallocate(WI,EUV,EUVs,Dpl,Dpls)
      endif
      ...
      if (datatype=='image_sxr') then
        ...
        SXR=0.0d0
        do iigrid=1,igridstail; igrid=igrids(iigrid);
          call integrate_SXR_data_resol(igrid,nXIF1,nXIF2,xIF1,xIF2,dxIF1,&
             dxIF2,fl,SXRs)
        enddo
        numSI=nXIF1*nXIF2
        call MPI_ALLREDUCE(SXRs,SXR,numSI,MPI_DOUBLE_PRECISION, MPI_SUM,icomm,&
    ...
    subroutine integrate_EUV_data_resol(igrid,nXIF1,nXIF2,xIF1,xIF2,dxIF1,&
       dxIF2,fl,EUV,Dpl)
      use mod_global_parameters
      ...
      double precision :: xbmin1,xbmin2,xbmin3,xbmax1,xbmax2,xbmax3,xd1,xd2,&
         xd3
      double precision, allocatable :: flux(:,:,:),v(:,:,:),rho(:,:,:)
      double precision, allocatable :: dxb1(:,:,:),dxb2(:,:,:),dxb3(:,:,:)
      double precision, allocatable :: EUVg(:,:),Fvg(:,:),xg1(:),xg2(:),&
         dxg1(:),dxg2(:)
      integer :: levelg,nXg1,nXg2,iXgmin1,iXgmax1,iXgmin2,iXgmax2,rft,iXg1,&
         iXg2,iXg3
      double precision :: EUVt,Fvt,xcmin1,xcmin2,xcmin3,xcmax1,xcmax2,xcmax3,&
         xgmin1,xgmin2,xgmin3,xgmax1,xgmax2,xgmax3,r2
      integer :: ixPmin1,ixPmin2,ixPmin3,ixPmax1,ixPmax2,ixPmax3,ixP1,ixP2,&
         ixP3
      integer :: direction_LOS
  ...
  xbmax3=rnode(rpxmax3_,igrid)
      ...
      allocate(flux(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         v(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         rho(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3))
      allocate(dxb1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         dxb2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
         dxb3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3))
      dxb1(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)=ps(igrid)%dx(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,1)
      dxb2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)=ps(igrid)%dx(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,2)
      dxb3(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)=ps(igrid)%dx(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,3)
      ! get local EUV flux and velocity
      call get_EUV(wavelength,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
      ...
      allocate(EUVg(nXg1,nXg2),Fvg(nXg1,nXg2),xg1(nXg1),xg2(nXg2),dxg1(nXg1),&
         dxg2(nXg2))
      EUVg=zero
      Fvg=zero
      xg1=zero
      ...
      case(1)
        do ix2=ixOmin2,ixOmax2
          ...
          do ix3=ixOmin3,ixOmax3
            ...
            Fvt=0.d0
            do ix1=ixOmin1,ixOmax1
              EUVt=EUVt+flux(ix1,ix2,ix3)*dxb1(ix1,ix2,ix3)*unit_length
              Fvt=Fvt+flux(ix1,ix2,ix3)*dxb1(ix1,ix2,ix3)*unit_length*v(ix1,&
                 ix2,ix3)
            enddo
      ...
      case(2)
        do ix3=ixOmin3,ixOmax3
          ...
          do ix1=ixOmin1,ixOmax1
            ...
            Fvt=0.d0
            do ix2=ixOmin2,ixOmax2
              EUVt=EUVt+flux(ix1,ix2,ix3)*dxb2(ix1,ix2,ix3)*unit_length
              Fvt=Fvt+flux(ix1,ix2,ix3)*dxb2(ix1,ix2,ix3)*unit_length*v(ix1,&
                 ix2,ix3)
            enddo
            EUVg(iXgmin1:iXgmax1,iXgmin2:iXgmax2)=EUVt
            Fvg(iXgmin1:iXgmax1,iXgmin2:iXgmax2)=Fvt
      ...
      case(3)
        do ix1=ixOmin1,ixOmax1
          ...
          do ix2=ixOmin2,ixOmax2
            ...
            Fvt=0.d0
            do ix3=ixOmin3,ixOmax3
              EUVt=EUVt+flux(ix1,ix2,ix3)*dxb3(ix1,ix2,ix3)*unit_length
              Fvt=Fvt+flux(ix1,ix2,ix3)*dxb3(ix1,ix2,ix3)*unit_length*v(ix1,&
                 ix2,ix3)
            enddo
            EUVg(iXgmin1:iXgmax1,iXgmin2:iXgmax2)=EUVt
            Fvg(iXgmin1:iXgmax1,iXgmin2:iXgmax2)=Fvt
      ...
      EUV(ixPmin1:ixPmax1,ixPmin2:ixPmax2)=EUV(ixPmin1:ixPmax1,&
         ixPmin2:ixPmax2)+EUVg(iXgmin1:iXgmax1,iXgmin2:iXgmax2)
      Dpl(ixPmin1:ixPmax1,ixPmin2:ixPmax2)=Dpl(ixPmin1:ixPmax1,&
         ixPmin2:ixPmax2)+FVg(iXgmin1:iXgmax1,iXgmin2:iXgmax2)

      deallocate(flux,v,dxb1,dxb2,dxb3,EUVg,Fvg,xg1,xg2,dxg1,dxg2)

    end subroutine integrate_EUV_data_resol

    subroutine integrate_SXR_data_resol(igrid,nXIF1,nXIF2,xIF1,xIF2,dxIF1,&
       dxIF2,fl,SXR)
      use mod_global_parameters
      ...
      integer :: levelg,nXg1,nXg2,iXgmin1,iXgmax1,iXgmin2,iXgmax2,rft,iXg1,&
         iXg2,iXg3
      double precision :: SXRt,xcmin1,xcmin2,xcmin3,xcmax1,xcmax2,xcmax3,&
         xgmin1,xgmin2,xgmin3,xgmax1,xgmax2,xgmax3,r2,area_1AU
      integer :: ixPmin1,ixPmin2,ixPmin3,ixPmax1,ixPmax2,ixPmax3,ixP1,ixP2,&
         ixP3
      integer :: direction_LOS
  ...
  xbmax3=rnode(rpxmax3_,igrid)
      ...
      case(1)
        do ix2=ixOmin2,ixOmax2
          ...
          do ix3=ixOmin3,ixOmax3
            ...
            SXRt=0.d0
            do ix1=ixOmin1,ixOmax1
              SXRt=SXRt+flux(ix1,ix2,ix3)*dxb1(ix1,ix2,ix3)*unit_length
            enddo
      ...
      case(2)
        do ix3=ixOmin3,ixOmax3
          ...
          do ix1=ixOmin1,ixOmax1
            ...
            SXRt=0.d0
            do ix2=ixOmin2,ixOmax2
              SXRt=SXRt+flux(ix1,ix2,ix3)*dxb2(ix1,ix2,ix3)*unit_length
            enddo
            SXRg(iXgmin1:iXgmax1,iXgmin2:iXgmax2)=SXRt
          enddo
        enddo
      case(3)
        do ix1=ixOmin1,ixOmax1
          ...
          do ix2=ixOmin2,ixOmax2
            ...
            SXRt=0.d0
            do ix3=ixOmin3,ixOmax3
              SXRt=SXRt+flux(ix1,ix2,ix3)*dxb3(ix1,ix2,ix3)*unit_length
            enddo
            SXRg(iXgmin1:iXgmax1,iXgmin2:iXgmax2)=SXRt
          enddo
        enddo
      ...
      dxg1(iXgmin1:iXgmax1)=dxIF1(ixPmin1:ixPmax1)
      dxg2(iXgmin2:iXgmax2)=dxIF2(ixPmin2:ixPmax2)
      SXR(ixPmin1:ixPmax1,ixPmin2:ixPmax2)=SXR(ixPmin1:ixPmax1,&
         ixPmin2:ixPmax2)+SXRg(iXgmin1:iXgmax1,iXgmin2:iXgmax2)
    ...
    subroutine output_data(qunit,xO1,xO2,dxO1,dxO2,wO,nXO1,nXO2,nWO,datatype)
      ...
      else if (datatype=='spectrum_euv' .and. resolution_spectrum=='data') &
         then
        piece_nmax1=16
...
("Error in synthesize emission: vti is not supported for data resolution")
            ...
            call write_image_vtiCC(qunit,xO1,xO2,dxO1,dxO2,wO,nXO1,nXO2,nWO,&
               nC1,nC2)
          endif
        case default
