...
contains
  ...
  subroutine nonlinear_average(wL, wR, x, ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,&
  ...
  subroutine nonlinear_get_eigenjump(wL, wR, wC, x, ixmin1,ixmin2,ixmin3,&
    ...
    call nonlinear_get_v(wL, x, ixGlo1,ixGlo2,ixGlo3,ixGhi1,ixGhi2,ixGhi3,&
        ixCmin1,ixCmin2,ixCmin3,ixCmax1,ixCmax2,ixCmax3, idim, v)
  ...
  subroutine nonlinear_rtimes(q, w, ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,&
