module mod_convert
  ...
  abstract interface
     ...
     function sub_convert_vars(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, w, x,&
         nwc) result(wnew)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
          ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, nwc
...
contains
  ...
  subroutine add_convert_method2(phys_convert_vars, nwc, aux_variable_names,&
    ...
    interface
     function phys_convert_vars(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
  ...
  subroutine convert_dat_generic(nwc, dataset_names, file_suffix,&
    ...
    integer                       :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
    ...
    interface
      ...
      function convert_vars(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
        ...
        integer, intent(in) :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
            ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, nwc
        double precision, intent(in) ::  x(ixImin1:ixImax1,ixImin2:ixImax2,&
           ixImin3:ixImax3,1:ndim)
        double precision, intent(in) :: w(ixImin1:ixImax1,ixImin2:ixImax2,&
           ixImin3:ixImax3,1:nw)
        double precision  :: wres(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3,1:nwc)
    ...
    do Morton_no=Morton_start(mype), Morton_stop(mype)
      ...
      w_buffer(1:n_values) = pack(convert_vars(ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,&
         ps(igrid)%w(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3, 1:nw),&
          ps(igrid)%x(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3, 1:ndim),&
         nwc), .true.)
