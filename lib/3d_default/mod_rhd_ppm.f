...
contains
  ...
  subroutine rhd_ppm_flatcd(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    if(rhd_energy) then
      drho(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = rhd_gamma*abs(d2w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
  ...
  subroutine rhd_ppm_flatsh(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    if(rhd_energy) then
      ...
      dp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) =(rhd_gamma*w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
