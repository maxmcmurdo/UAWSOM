...
contains
  ...
  subroutine hd_diffuse_hllcd(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
  ...
  subroutine hd_get_lCD(wLC,wRC,fLC,fRC,cmin,cmax,idim,ixImin1,ixImin2,ixImin3,&
