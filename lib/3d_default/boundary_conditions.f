...
subroutine bc_phys(iside,idims,time,qdt,s,ixGmin1,ixGmin2,ixGmin3,ixGmax1,&
  ...
  integer, intent(in) :: iside, idims, ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,&
     ixGmax3,ixBmin1,ixBmin2,ixBmin3,ixBmax1,ixBmax2,ixBmax3
 ...
 !this just multiplies the variables with (-), they have been set from neighbors just like periodic.
              w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
                 iw) = - w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,iw)
           case (bc_data)
              ! skip it here, do AFTER all normal type boundaries are set
           case (bc_character)
              ! skip it here, do AFTER all normal type boundaries are set
            ...
            case (bc_cont)
              do ix1=ixOsmin1,ixOsmax1
                 ws(ix1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
                    idir) = ws(ixOsmin1-1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
                    idir)
              end do
            case (bc_symm)
 ...
 !fill the normal components using a prescription for the divergence.
          ...
          do idir=1,nws
            ...
            case(bc_cont)
              ...
              do ix1=0,nghostcells-1
                call get_divb(s%w,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,&
                   ixGmax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,Qp)
                ws(ixOsmin1+ix1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
                   ...
                   ixOmin3:ixOmax3))/s%surfaceC(ixOsmin1+ix1,ixOsmin2:ixOsmax2,&
                   ixOsmin3:ixOsmax3,1)
              end do
            case(bc_symm)
          ...
          ! Fill cell averages
          call phys_face_to_center(ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,&
             ixOmax3,s)
        end if
     else
        ! minimal boundary
        ...
        do iw=1,nwflux+nwaux
           ...
           case(bc_noinflow)
              if (iw==1+1)then
                 do ix1=ixOmin1,ixOmax1
                   w(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,iw) = min(w(ixOmax1+1,&
                      ixOmin2:ixOmax2,ixOmin3:ixOmax3,iw),zero)
                 end do
              else
                 do ix1=ixOmin1,ixOmax1
                   w(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,iw) = w(ixOmax1+1,&
 ...
 !At this stage, extrapolation is applied only to the tangential components
            ...
            case (bc_cont)
              do ix1=ixOsmin1,ixOsmax1
                 ws(ix1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
                    idir) = ws(ixOsmax1+1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
                    idir)
              end do
            case (bc_symm)
              ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
            ...
            case(bc_cont)
              ...
              do ix1=0,nghostcells-1
                ...
                ws(ixOsmax1-ix1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
                   ...
                   ixOmin3:ixOmax3))/s%surfaceC(ixOsmax1-ix1,ixOsmin2:ixOsmax2,&
                   ixOsmin3:ixOsmax3,1)
              end do
            case(bc_symm)
              ! (a)symmetric normal B ensures symmetric divB
        ...
        do iw=1,nwflux+nwaux
           ...
           case (bc_cont)
              do ix2=ixOmin2,ixOmax2
                 w(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,iw) = w(ixOmin1:ixOmax1,&
                    ixOmin2-1,ixOmin3:ixOmax3,iw)
              end do
           case (bc_symm)
              w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
            ...
            case (bc_cont)
              do ix2=ixOsmin2,ixOsmax2
                 ws(ixOsmin1:ixOsmax1,ix2,ixOsmin3:ixOsmax3,&
                    idir) = ws(ixOsmin1:ixOsmax1,ixOsmin2-1,ixOsmin3:ixOsmax3,&
                    idir)
              end do
            case (bc_symm)
              ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
            ...
            case(bc_cont)
              ...
              do ix2=0,nghostcells-1
                ...
                ws(ixOsmin1:ixOsmax1,ixOsmin2+ix2,ixOsmin3:ixOsmax3,&
                   ...
                   ixOmin3:ixOmax3))/s%surfaceC(ixOsmin1:ixOsmax1,ixOsmin2+ix2,&
                   ixOsmin3:ixOsmax3,2)
              end do
            case(bc_symm)
              ! (a)symmetric normal B ensures symmetric divB
              ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
                 idir)= ws(ixOsmin1:ixOsmax1,&
                 ixOsmin2-2:ixOsmin2-nghostcells-1:-1,ixOsmin3:ixOsmax3,idir)
            case(bc_asymm)
              ! (a)symmetric normal B ensures symmetric divB
              ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
                 idir)=-ws(ixOsmin1:ixOsmax1,&
 ...
 !At this stage, extrapolation is applied only to the tangential components
            ...
            case (bc_cont)
              do ix2=ixOsmin2,ixOsmax2
                 ws(ixOsmin1:ixOsmax1,ix2,ixOsmin3:ixOsmax3,&
                    idir) = ws(ixOsmin1:ixOsmax1,ixOsmax2+1,ixOsmin3:ixOsmax3,&
                    idir)
              end do
            case (bc_symm)
              ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
            ...
            case(bc_cont)
              ...
              do ix2=0,nghostcells-1
                ...
                ws(ixOsmin1:ixOsmax1,ixOsmax2-ix2,ixOsmin3:ixOsmax3,&
                   ...
                   ixOmin3:ixOmax3))/s%surfaceC(ixOsmin1:ixOsmax1,ixOsmax2-ix2,&
                   ixOsmin3:ixOsmax3,2)
              end do
            case(bc_symm)
              ! (a)symmetric normal B ensures symmetric divB
              ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
                 idir)= ws(ixOsmin1:ixOsmax1,&
                 ixOsmax2+nghostcells+1:ixOsmax2+2:-1,ixOsmin3:ixOsmax3,idir)
            case(bc_asymm)
              ! (a)symmetric normal B ensures symmetric divB
              ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
                 idir)=-ws(ixOsmin1:ixOsmax1,&
        ...
        do iw=1,nwflux+nwaux
           ...
           case (bc_cont)
              do ix3=ixOmin3,ixOmax3
                 w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ix3,iw) = w(ixOmin1:ixOmax1,&
                    ixOmin2:ixOmax2,ixOmin3-1,iw)
              end do
           case (bc_symm)
              w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
            ...
            case (bc_cont)
              do ix3=ixOsmin3,ixOsmax3
                 ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ix3,&
                    idir) = ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmin3-1,&
                    idir)
              end do
            case (bc_symm)
              ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
 ...
 !At this stage, extrapolation is applied only to the tangential components
            ...
            case (bc_cont)
              do ix3=ixOsmin3,ixOsmax3
                 ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ix3,&
                    idir) = ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmax3+1,&
                    idir)
              end do
            case (bc_symm)
              ws(ixOsmin1:ixOsmax1,ixOsmin2:ixOsmax2,ixOsmin3:ixOsmax3,&
 ...
 !fill the normal components using a prescription for the divergence.
  ...
  if (any(typeboundary(1:nwflux+nwaux,iB)==bc_special)) then
     ...
     call usr_special_bc(time,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,&
...
subroutine getintbc(time,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3)
  ...
  do iigrid=1,igridstail_active; igrid=igrids_active(iigrid);
     ...
     if (associated(usr_internal_bc)) then
        call usr_internal_bc(node(plevel_,igrid),time,ixGmin1,ixGmin2,ixGmin3,&
           ixGmax1,ixGmax2,ixGmax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,&
           ixOmax3,ps(igrid)%w,ps(igrid)%x)
     end if
  end do
  !$OMP END PARALLEL DO
