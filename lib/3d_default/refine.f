...
subroutine prolong_2nd(sCo,ixComin1,ixComin2,ixComin3,ixComax1,ixComax2,&
  ...
  if(stagger_grid) then
    call already_fine(sFi,igridFi,fine_min1,fine_min2,fine_min3,fine_max1,&
       fine_max2,fine_max3)
    call prolong_2nd_stg(sCo,sFi,ixComin1,ixComin2,ixComin3,ixComax1,ixComax2,&
       ixComax3,ixMlo1,ixMlo2,ixMlo3,ixMhi1,ixMhi2,ixMhi3,dxCo1,dxCo2,dxCo3,&
       xComin1,xComin2,xComin3,dxFi1,dxFi2,dxFi3,xFimin1,xFimin2,xFimin3,&
       .false.,fine_min1,fine_min2,fine_min3,fine_max1,fine_max2,fine_max3)
  end if
...
subroutine prolong_1st(wCo,ixComin1,ixComin2,ixComin3,ixComax1,ixComax2,&
  ...
  double precision, intent(in) :: wCo(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
     ixGlo3:ixGhi3,nw), xFi(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,1:ndim)
