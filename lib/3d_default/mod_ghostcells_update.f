...
contains
  ...
  subroutine getbc(time,qdt,psb,nwstart,nwbc,req_diag)
    ...
    integer :: i1,i2,i3, n_i1,n_i2,n_i3, ic1,ic2,ic3, inc1,inc2,inc3, n_inc1,&
       n_inc2,n_inc3, iib1,iib2,iib3, idir
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
      ...
      do i1=-1,1
        if(skip_direction([ i1,i2,i3 ])) cycle
         select case (neighbor_type(i1,i2,i3,igrid))
         case(neighbor_sibling)
           call bc_fill_srl(igrid,i1,i2,i3,iib1,iib2,iib3)
         case(neighbor_coarse)
           call bc_fill_restrict(igrid,i1,i2,i3,iib1,iib2,iib3)
         end select
      end do
      end do
      end do
    ...
    contains
      ...
      subroutine bc_fill_srl(igrid,i1,i2,i3,iib1,iib2,iib3)
      ...
      subroutine bc_recv_prolong
        ...
        if (ipe_neighbor/=mype) then
           ...
           call MPI_IRECV(psc(igrid)%w,1,type_recv_p(iib1,iib2,iib3,inc1,inc2,&
              inc3), ipe_neighbor,itag,icomm,recvrequest_c_p(irecv_c),&
              ierrmpi)  
           if(stagger_grid) then
             irecv_p=irecv_p+1
