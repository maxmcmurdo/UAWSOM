...
module mod_usr_methods
  ...
  abstract interface
    ...
    !> Initialize one grid
    subroutine init_one_grid(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
     ...
     subroutine special_bc(qt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    subroutine internal_bc(level,qt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,level
    ...
    subroutine process_grid(igrid,level,ixImin1,ixImin2,ixImin3,ixImax1,&
    ...
    subroutine sub_modify_io(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    subroutine process_adv_grid(igrid,level,ixImin1,ixImin2,ixImin3,ixImax1,&
       ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,qt,w,x)
      use mod_global_parameters
      integer, intent(in)             :: igrid,level,ixImin1,ixImin2,ixImin3,&
         ixImax1,ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,&
    ...
    subroutine aux_output(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    subroutine source(qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
       ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,iwmin,iwmax,qtC,wCT,qt,&
       w,x)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,&
    ...
    subroutine get_dt(w,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    subroutine phys_gravity(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
       ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,wCT,x,gravity_field)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3
      double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
    ...
    subroutine phys_dust_get_3d_dragforce(ixImin1,ixImin2,ixImin3,ixImax1,&
       ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, w, x,&
        fdrag, ptherm, vgas,dust_n_species)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,&
          dust_n_species
      ...
      double precision, intent(in)    :: ptherm(ixImin1:ixImax1,&
         ixImin2:ixImax2,ixImin3:ixImax3), vgas(ixImin1:ixImax1,&
    ...
    subroutine phys_dust_get_dt(w, ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, dtdust, dx1,&
       dx2,dx3, x, dust_n_species)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,&
          dust_n_species
    ...
    subroutine phys_visco(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
       ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,x,w,mu)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3
      double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
    ...
    subroutine hd_pthermal(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    subroutine special_resistivity(w,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idirmin,x,&
       current,eta)
      use mod_global_parameters
      integer, intent(in)          :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
         ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, idirmin
      double precision, intent(in) :: w(ixImin1:ixImax1,ixImin2:ixImax2,&
    ...
    subroutine special_opacity(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    subroutine special_aniso_opacity(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,kappa,idir)
      use mod_global_parameters
      integer, intent(in)          :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
    ...
    subroutine special_opacity_qdot(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
    ...
    subroutine special_fluxlimiter(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,fld_lambda,&
       fld_R)
      use mod_global_parameters
      integer, intent(in)          :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
         ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3
      ...
      double precision, intent(out):: fld_lambda(ixImin1:ixImax1,&
         ixImin2:ixImax2,ixImin3:ixImax3),fld_R(ixImin1:ixImax1,&
         ixImin2:ixImax2,ixImin3:ixImax3)
    end subroutine special_fluxlimiter

    !> Set user defined FLD diffusion coefficient
    subroutine special_diffcoef(w, wCT, x, ixImin1,ixImin2,ixImin3,ixImax1,&
       ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3)
      use mod_global_parameters
      integer, intent(in)          :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
         ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3
    ...
    subroutine refine_grid(igrid,level,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,qt,w,x,refine,&
       coarsen)
      use mod_global_parameters
      integer, intent(in)          :: igrid, level, ixImin1,ixImin2,ixImin3,&
         ixImax1,ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,&
    ...
    subroutine var_for_errest(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
       ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,iflag,w,x,var)
      use mod_global_parameters
      integer, intent(in)           :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
    ...
    subroutine set_B0(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,&
       ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,x,wB0)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3
      double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
    ...
    subroutine set_J0(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,&
       ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,x,wJ0)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3
      double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
    ...
    subroutine set_equi_vars(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
       ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,x,w0)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3
      double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,1:ndim)
      double precision, intent(inout) :: w0(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,1:number_equi_vars)
    end subroutine set_equi_vars

    !> adjust w when restart from dat file with different w variables
    subroutine transform_w(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
       ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,nw_in,w_in,x,w_out)
      use mod_global_parameters
      integer, intent(in)           :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
         ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, nw_in
      double precision, intent(in)  :: w_in(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,1:nw_in)
      double precision, intent(in)  :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3, 1:ndim)
    ...
    subroutine flag_grid(qt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    subroutine update_payload(igrid,w,wold,xgrid,x,u,q,m,mypayload,mynpayload,&
      ...
      double precision, intent(in)  :: xgrid(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         ixGlo3:ixGhi3,1:ndim),x(1:ndir),u(1:ndir),q,m,particle_time
    ...
    subroutine particle_fields(w, x, E, B)
      ...
      double precision, intent(out) :: E(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         ixGlo3:ixGhi3, ndir)
      double precision, intent(out) :: B(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         ixGlo3:ixGhi3, ndir)
    ...
    !> initialize vector potential on cell edges for magnetic field
    subroutine init_vector_potential(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3, ixCmin1,ixCmin2,ixCmin3,ixCmax1,ixCmax2,ixCmax3, xC, A, idir)
      use mod_global_parameters

      integer, intent(in)                :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3, ixCmin1,ixCmin2,ixCmin3,ixCmax1,ixCmax2,ixCmax3,&
          idir
    ...
    ! allow user to change inductive electric field, especially for boundary driven applications
    subroutine set_electric_field(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
    ...
    subroutine set_wLR(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,&
       ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,qt,wLC,wRC,wLp,wRp,s,idir)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,&
          idir
    ...
    subroutine set_surface(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,x,&
       delx,exp_factor,del_exp_factor,exp_factor_primitive)
      use mod_global_parameters
      integer, intent(in)              :: ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3
      double precision, intent(in)     :: delx(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,1:ndim), x(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,1:ndim)
      double precision, intent(out)    :: exp_factor(ixImin1:ixImax1,&
         ixImin2:ixImax2,ixImin3:ixImax3), del_exp_factor(ixImin1:ixImax1,&
         ixImin2:ixImax2,ixImin3:ixImax3)
