...
contains
  ...
  subroutine advect1(method,dtfactor,idimmin,idimmax,qtC,psa,qt,psb)
    ...
    do iigrid=1,igridstail_active; igrid=igrids_active(iigrid);
       ...
       call process1_grid(method(block%level),igrid,qdt,ixGlo1,ixGlo2,ixGlo3,&
          ixGhi1,ixGhi2,ixGhi3,idimmin,idimmax,qtC,psa(igrid),qt,psb(igrid),&
          pso(igrid))
    end do
    !$OMP END PARALLEL DO
    ...
    if (fix_conserve_global .and. fix_conserve_at_step) then
      ...
      if(phys_solve_eaux) then
        ...
        !$OMP PARALLEL DO PRIVATE(igrid)
        do iigrid=1,igridstail_active; igrid=igrids_active(iigrid);
          call phys_energy_synchro(ixGlo1,ixGlo2,ixGlo3,ixGhi1,ixGhi2,ixGhi3,&
             ixMlo1,ixMlo2,ixMlo3,ixMhi1,ixMhi2,ixMhi3,psb(igrid)%w,&
             psb(igrid)%x)
        end do
        !$OMP END PARALLEL DO
      end if
  ...
  subroutine process1_grid(method,igrid,qdt,ixImin1,ixImin2,ixImin3,ixImax1,&
    ...
    call advect1_grid(method,qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3,idimmin,idimmax,qtC,sCT,qt,s,sold,fC,fE,rnode(rpdx1_:rnodehi,&
       igrid),ps(igrid)%x)
    ...
    if (fix_conserve_global .and. fix_conserve_at_step) then
      ...
      if(stagger_grid) call store_edge(igrid,ixImin1,ixImin2,ixImin3,ixImax1,&
         ixImax2,ixImax3,fE,idimmin,idimmax)
    end if
  ...
  subroutine advect1_grid(method,qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
     ixImax3,idimmin,idimmax,qtC,sCT,qt,s,sold,fC,fE,dxs,x)
    ...
    case (fs_hll,fs_hllc,fs_hllcd,fs_hlld,fs_tvdlf,fs_tvdmu)
       call finite_volume(method,qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
          ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idimmin,&
          idimmax,qtC,sCT,qt,s,sold,fC,fE,dxs,x)
    case (fs_cd,fs_cd4)
       call centdiff(method,qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
          ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idimmin,&
          idimmax,qtC,sCT,qt,s,fC,fE,dxs,x)
    case (fs_hancock)
       call hancock(qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
          ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idimmin,idimmax,qtC,&
          sCT,qt,s,dxs,x)
    case (fs_fd)
       call fd(qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,&
          ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idimmin,idimmax,qtC,sCT,qt,s,&
          fC,fE,dxs,x)
    case (fs_tvd)
       call centdiff(fs_cd,qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
          ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idimmin,idimmax,qtC,&
          sCT,qt,s,fC,fE,dxs,x)
       call tvdlimit(method,qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
          ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idimmin,&
    ...
    case (fs_source)
       call addsource2(qdt*dble(idimmax-idimmin+1)/dble(ndim),ixImin1,ixImin2,&
          ...
          ixOmax2,ixOmax3,1,nw,qtC,sCT%w,qt,s%w,x,.false.)
    case (fs_nul)
